    ...
    async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            case 'availability:AvailabilityUnitsGet': {
                ...
                const AvailabilityUnitsGet_propertyId_value = this.getNodeParameter('AvailabilityUnitsGet_propertyId', i);
                if (AvailabilityUnitsGet_propertyId_value !== undefined && AvailabilityUnitsGet_propertyId_value !== '' && (!Array.isArray(AvailabilityUnitsGet_propertyId_value) || AvailabilityUnitsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = AvailabilityUnitsGet_propertyId_value;
                }

                const AvailabilityUnitsGet_from_value = this.getNodeParameter('AvailabilityUnitsGet_from', i);
                if (AvailabilityUnitsGet_from_value !== undefined && AvailabilityUnitsGet_from_value !== '' && (!Array.isArray(AvailabilityUnitsGet_from_value) || AvailabilityUnitsGet_from_value.length > 0)) {
                    qs['from'] = AvailabilityUnitsGet_from_value;
                }

                const AvailabilityUnitsGet_to_value = this.getNodeParameter('AvailabilityUnitsGet_to', i);
                if (AvailabilityUnitsGet_to_value !== undefined && AvailabilityUnitsGet_to_value !== '' && (!Array.isArray(AvailabilityUnitsGet_to_value) || AvailabilityUnitsGet_to_value.length > 0)) {
                    qs['to'] = AvailabilityUnitsGet_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('AvailabilityUnitsGet_additionalFields', i) as IDataObject;
                ...
                responseData = await this.helpers.httpRequestWithAuthentication.call(this, 'apaleoOAuth2Api', requestOptions);
                break;
            }
            ...
            case 'availability:AvailabilityUnit-groupsGet': {
                ...
                const AvailabilityUnit_groupsGet_propertyId_value = this.getNodeParameter('AvailabilityUnit_groupsGet_propertyId', i);
                if (AvailabilityUnit_groupsGet_propertyId_value !== undefined && AvailabilityUnit_groupsGet_propertyId_value !== '' && (!Array.isArray(AvailabilityUnit_groupsGet_propertyId_value) || AvailabilityUnit_groupsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = AvailabilityUnit_groupsGet_propertyId_value;
                }

                const AvailabilityUnit_groupsGet_from_value = this.getNodeParameter('AvailabilityUnit_groupsGet_from', i);
                if (AvailabilityUnit_groupsGet_from_value !== undefined && AvailabilityUnit_groupsGet_from_value !== '' && (!Array.isArray(AvailabilityUnit_groupsGet_from_value) || AvailabilityUnit_groupsGet_from_value.length > 0)) {
                    qs['from'] = AvailabilityUnit_groupsGet_from_value;
                }

                const AvailabilityUnit_groupsGet_to_value = this.getNodeParameter('AvailabilityUnit_groupsGet_to', i);
                if (AvailabilityUnit_groupsGet_to_value !== undefined && AvailabilityUnit_groupsGet_to_value !== '' && (!Array.isArray(AvailabilityUnit_groupsGet_to_value) || AvailabilityUnit_groupsGet_to_value.length > 0)) {
                    qs['to'] = AvailabilityUnit_groupsGet_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('AvailabilityUnit_groupsGet_additionalFields', i) as IDataObject;
            ...
            case 'availability:AvailabilityUnit-groupsByIdPatch': {
                ...
                const AvailabilityUnit_groupsByIdPatch_from_value = this.getNodeParameter('AvailabilityUnit_groupsByIdPatch_from', i);
                if (AvailabilityUnit_groupsByIdPatch_from_value !== undefined && AvailabilityUnit_groupsByIdPatch_from_value !== '' && (!Array.isArray(AvailabilityUnit_groupsByIdPatch_from_value) || AvailabilityUnit_groupsByIdPatch_from_value.length > 0)) {
                    qs['from'] = AvailabilityUnit_groupsByIdPatch_from_value;
                }

                const AvailabilityUnit_groupsByIdPatch_to_value = this.getNodeParameter('AvailabilityUnit_groupsByIdPatch_to', i);
                if (AvailabilityUnit_groupsByIdPatch_to_value !== undefined && AvailabilityUnit_groupsByIdPatch_to_value !== '' && (!Array.isArray(AvailabilityUnit_groupsByIdPatch_to_value) || AvailabilityUnit_groupsByIdPatch_to_value.length > 0)) {
                    qs['to'] = AvailabilityUnit_groupsByIdPatch_to_value;
                }

                const AvailabilityUnit_groupsByIdPatch_timeSliceTemplate_value = this.getNodeParameter('AvailabilityUnit_groupsByIdPatch_timeSliceTemplate', i);
                if (AvailabilityUnit_groupsByIdPatch_timeSliceTemplate_value !== undefined && AvailabilityUnit_groupsByIdPatch_timeSliceTemplate_value !== '' && (!Array.isArray(AvailabilityUnit_groupsByIdPatch_timeSliceTemplate_value) || AvailabilityUnit_groupsByIdPatch_timeSliceTemplate_value.length > 0)) {
            ...
            case 'availability:AvailabilityServicesGet': {
                ...
                const AvailabilityServicesGet_propertyId_value = this.getNodeParameter('AvailabilityServicesGet_propertyId', i);
                if (AvailabilityServicesGet_propertyId_value !== undefined && AvailabilityServicesGet_propertyId_value !== '' && (!Array.isArray(AvailabilityServicesGet_propertyId_value) || AvailabilityServicesGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = AvailabilityServicesGet_propertyId_value;
                }

                const AvailabilityServicesGet_from_value = this.getNodeParameter('AvailabilityServicesGet_from', i);
                if (AvailabilityServicesGet_from_value !== undefined && AvailabilityServicesGet_from_value !== '' && (!Array.isArray(AvailabilityServicesGet_from_value) || AvailabilityServicesGet_from_value.length > 0)) {
                    qs['from'] = AvailabilityServicesGet_from_value;
                }

                const AvailabilityServicesGet_to_value = this.getNodeParameter('AvailabilityServicesGet_to', i);
                if (AvailabilityServicesGet_to_value !== undefined && AvailabilityServicesGet_to_value !== '' && (!Array.isArray(AvailabilityServicesGet_to_value) || AvailabilityServicesGet_to_value.length > 0)) {
                    qs['to'] = AvailabilityServicesGet_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('AvailabilityServicesGet_additionalFields', i) as IDataObject;
            ...
            case 'reservationavailability:AvailabilityReservationsByIdUnitsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('AvailabilityReservationsByIdUnitsGet_additionalFields', i) as IDataObject;
            ...
            case 'block:BookingBlocksPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBlocksPost_additionalFields', i) as IDataObject;
            ...
            case 'block:BookingBlocksGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBlocksGet_additionalFields', i) as IDataObject;
            ...
            case 'block:BookingBlocks$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBlocks_countGet_additionalFields', i) as IDataObject;
            ...
            case 'block:BookingBlocksByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBlocksByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'booking:BookingBookingsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBookingsPost_additionalFields', i) as IDataObject;
            ...
            case 'booking:BookingBookingsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBookingsGet_additionalFields', i) as IDataObject;
            ...
            case 'booking:BookingBookings$forcePost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBookings_forcePost_additionalFields', i) as IDataObject;
            ...
            case 'booking:BookingBookingsByIdReservationsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBookingsByIdReservationsPost_additionalFields', i) as IDataObject;
            ...
            case 'booking:BookingBookingsByIdReservations$forcePost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBookingsByIdReservations_forcePost_additionalFields', i) as IDataObject;
            ...
            case 'booking:BookingBookingsByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingBookingsByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'group:BookingGroupsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingGroupsPost_additionalFields', i) as IDataObject;
            ...
            case 'group:BookingGroupsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingGroupsGet_additionalFields', i) as IDataObject;
            ...
            case 'group:BookingGroupsByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingGroupsByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'group:BookingGroupsByIdReservationsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingGroupsByIdReservationsPost_additionalFields', i) as IDataObject;
            ...
            case 'offer:BookingOffersGet': {
                ...
                const BookingOffersGet_propertyId_value = this.getNodeParameter('BookingOffersGet_propertyId', i);
                if (BookingOffersGet_propertyId_value !== undefined && BookingOffersGet_propertyId_value !== '' && (!Array.isArray(BookingOffersGet_propertyId_value) || BookingOffersGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = BookingOffersGet_propertyId_value;
                }

                const BookingOffersGet_arrival_value = this.getNodeParameter('BookingOffersGet_arrival', i);
                if (BookingOffersGet_arrival_value !== undefined && BookingOffersGet_arrival_value !== '' && (!Array.isArray(BookingOffersGet_arrival_value) || BookingOffersGet_arrival_value.length > 0)) {
                    qs['arrival'] = BookingOffersGet_arrival_value;
                }

                const BookingOffersGet_departure_value = this.getNodeParameter('BookingOffersGet_departure', i);
                if (BookingOffersGet_departure_value !== undefined && BookingOffersGet_departure_value !== '' && (!Array.isArray(BookingOffersGet_departure_value) || BookingOffersGet_departure_value.length > 0)) {
                    qs['departure'] = BookingOffersGet_departure_value;
                }

                const BookingOffersGet_adults_value = this.getNodeParameter('BookingOffersGet_adults', i);
                if (BookingOffersGet_adults_value !== undefined && BookingOffersGet_adults_value !== '' && (!Array.isArray(BookingOffersGet_adults_value) || BookingOffersGet_adults_value.length > 0)) {
                    qs['adults'] = BookingOffersGet_adults_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingOffersGet_additionalFields', i) as IDataObject;
            ...
            case 'offer:BookingRate-plan-offersGet': {
                ...
                const BookingRate_plan_offersGet_ratePlanId_value = this.getNodeParameter('BookingRate_plan_offersGet_ratePlanId', i);
                if (BookingRate_plan_offersGet_ratePlanId_value !== undefined && BookingRate_plan_offersGet_ratePlanId_value !== '' && (!Array.isArray(BookingRate_plan_offersGet_ratePlanId_value) || BookingRate_plan_offersGet_ratePlanId_value.length > 0)) {
                    qs['ratePlanId'] = BookingRate_plan_offersGet_ratePlanId_value;
                }

                const BookingRate_plan_offersGet_arrival_value = this.getNodeParameter('BookingRate_plan_offersGet_arrival', i);
                if (BookingRate_plan_offersGet_arrival_value !== undefined && BookingRate_plan_offersGet_arrival_value !== '' && (!Array.isArray(BookingRate_plan_offersGet_arrival_value) || BookingRate_plan_offersGet_arrival_value.length > 0)) {
                    qs['arrival'] = BookingRate_plan_offersGet_arrival_value;
                }

                const BookingRate_plan_offersGet_departure_value = this.getNodeParameter('BookingRate_plan_offersGet_departure', i);
                if (BookingRate_plan_offersGet_departure_value !== undefined && BookingRate_plan_offersGet_departure_value !== '' && (!Array.isArray(BookingRate_plan_offersGet_departure_value) || BookingRate_plan_offersGet_departure_value.length > 0)) {
                    qs['departure'] = BookingRate_plan_offersGet_departure_value;
                }

                const BookingRate_plan_offersGet_adults_value = this.getNodeParameter('BookingRate_plan_offersGet_adults', i);
                if (BookingRate_plan_offersGet_adults_value !== undefined && BookingRate_plan_offersGet_adults_value !== '' && (!Array.isArray(BookingRate_plan_offersGet_adults_value) || BookingRate_plan_offersGet_adults_value.length > 0)) {
                    qs['adults'] = BookingRate_plan_offersGet_adults_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingRate_plan_offersGet_additionalFields', i) as IDataObject;
            ...
            case 'offer:BookingService-offersGet': {
                ...
                const BookingService_offersGet_ratePlanId_value = this.getNodeParameter('BookingService_offersGet_ratePlanId', i);
                if (BookingService_offersGet_ratePlanId_value !== undefined && BookingService_offersGet_ratePlanId_value !== '' && (!Array.isArray(BookingService_offersGet_ratePlanId_value) || BookingService_offersGet_ratePlanId_value.length > 0)) {
                    qs['ratePlanId'] = BookingService_offersGet_ratePlanId_value;
                }

                const BookingService_offersGet_arrival_value = this.getNodeParameter('BookingService_offersGet_arrival', i);
                if (BookingService_offersGet_arrival_value !== undefined && BookingService_offersGet_arrival_value !== '' && (!Array.isArray(BookingService_offersGet_arrival_value) || BookingService_offersGet_arrival_value.length > 0)) {
                    qs['arrival'] = BookingService_offersGet_arrival_value;
                }

                const BookingService_offersGet_departure_value = this.getNodeParameter('BookingService_offersGet_departure', i);
                if (BookingService_offersGet_departure_value !== undefined && BookingService_offersGet_departure_value !== '' && (!Array.isArray(BookingService_offersGet_departure_value) || BookingService_offersGet_departure_value.length > 0)) {
                    qs['departure'] = BookingService_offersGet_departure_value;
                }

                const BookingService_offersGet_adults_value = this.getNodeParameter('BookingService_offersGet_adults', i);
                if (BookingService_offersGet_adults_value !== undefined && BookingService_offersGet_adults_value !== '' && (!Array.isArray(BookingService_offersGet_adults_value) || BookingService_offersGet_adults_value.length > 0)) {
                    qs['adults'] = BookingService_offersGet_adults_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingService_offersGet_additionalFields', i) as IDataObject;
            ...
            case 'offer:BookingOffer-indexGet': {
                ...
                const BookingOffer_indexGet_ratePlanId_value = this.getNodeParameter('BookingOffer_indexGet_ratePlanId', i);
                if (BookingOffer_indexGet_ratePlanId_value !== undefined && BookingOffer_indexGet_ratePlanId_value !== '' && (!Array.isArray(BookingOffer_indexGet_ratePlanId_value) || BookingOffer_indexGet_ratePlanId_value.length > 0)) {
                    qs['ratePlanId'] = BookingOffer_indexGet_ratePlanId_value;
                }

                const BookingOffer_indexGet_from_value = this.getNodeParameter('BookingOffer_indexGet_from', i);
                if (BookingOffer_indexGet_from_value !== undefined && BookingOffer_indexGet_from_value !== '' && (!Array.isArray(BookingOffer_indexGet_from_value) || BookingOffer_indexGet_from_value.length > 0)) {
                    qs['from'] = BookingOffer_indexGet_from_value;
                }

                const BookingOffer_indexGet_to_value = this.getNodeParameter('BookingOffer_indexGet_to', i);
                if (BookingOffer_indexGet_to_value !== undefined && BookingOffer_indexGet_to_value !== '' && (!Array.isArray(BookingOffer_indexGet_to_value) || BookingOffer_indexGet_to_value.length > 0)) {
                    qs['to'] = BookingOffer_indexGet_to_value;
                }

                const BookingOffer_indexGet_channelCode_value = this.getNodeParameter('BookingOffer_indexGet_channelCode', i);
                if (BookingOffer_indexGet_channelCode_value !== undefined && BookingOffer_indexGet_channelCode_value !== '' && (!Array.isArray(BookingOffer_indexGet_channelCode_value) || BookingOffer_indexGet_channelCode_value.length > 0)) {
                    qs['channelCode'] = BookingOffer_indexGet_channelCode_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingOffer_indexGet_additionalFields', i) as IDataObject;
            ...
            case 'reservation:BookingReservationsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservationsGet_additionalFields', i) as IDataObject;
            ...
            case 'reservation:BookingReservations$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservations_countGet_additionalFields', i) as IDataObject;
            ...
            case 'reservation:BookingReservationsByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservationsByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'reservation:BookingReservationsByIdOffersGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservationsByIdOffersGet_additionalFields', i) as IDataObject;
            ...
            case 'reservation:BookingReservationsByIdService-offersGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservationsByIdService_offersGet_additionalFields', i) as IDataObject;
            ...
            case 'reservation:BookingReservationsByIdServicesDelete': {
                ...
                const BookingReservationsByIdServicesDelete_serviceId_value = this.getNodeParameter('BookingReservationsByIdServicesDelete_serviceId', i);
                if (BookingReservationsByIdServicesDelete_serviceId_value !== undefined && BookingReservationsByIdServicesDelete_serviceId_value !== '' && (!Array.isArray(BookingReservationsByIdServicesDelete_serviceId_value) || BookingReservationsByIdServicesDelete_serviceId_value.length > 0)) {
            ...
            case 'reservationactions:BookingReservation-actionsByIdAssign-unitPut': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservation_actionsByIdAssign_unitPut_additionalFields', i) as IDataObject;
            ...
            case 'reservationactions:BookingReservation-actionsByIdAssign-unitByUnitIdPut': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservation_actionsByIdAssign_unitByUnitIdPut_additionalFields', i) as IDataObject;
            ...
            case 'reservationactions:BookingReservation-actionsByIdCheckinPut': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingReservation_actionsByIdCheckinPut_additionalFields', i) as IDataObject;
            ...
            case 'types:BookingTypesByTypeAllowed-valuesGet': {
                ...
                const BookingTypesByTypeAllowed_valuesGet_countryCode_value = this.getNodeParameter('BookingTypesByTypeAllowed_valuesGet_countryCode', i);
                if (BookingTypesByTypeAllowed_valuesGet_countryCode_value !== undefined && BookingTypesByTypeAllowed_valuesGet_countryCode_value !== '' && (!Array.isArray(BookingTypesByTypeAllowed_valuesGet_countryCode_value) || BookingTypesByTypeAllowed_valuesGet_countryCode_value.length > 0)) {
                    qs['countryCode'] = BookingTypesByTypeAllowed_valuesGet_countryCode_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('BookingTypesByTypeAllowed_valuesGet_additionalFields', i) as IDataObject;
            ...
            case 'folio:FinanceFoliosGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosGet_additionalFields', i) as IDataObject;
                ...
                if (additionalFields['checkedOutOnAccountsReceivable'] !== undefined) {
                    qs['checkedOutOnAccountsReceivable'] = additionalFields['checkedOutOnAccountsReceivable'];
                }
            ...
            case 'folio:FinanceFoliosPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosPost_additionalFields', i) as IDataObject;
            ...
            case 'folio:FinanceFolios$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolios_countGet_additionalFields', i) as IDataObject;
            ...
            case 'folio:FinanceFoliosByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdChargesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdChargesPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdTransitory-chargesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdTransitory_chargesPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdCancellation-feePost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdCancellation_feePost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdNo-show-feePost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdNo_show_feePost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdChargesByChargeIdAllowancesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdChargesByChargeIdAllowancesPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdAllowancesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdAllowancesPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdBulk-allowancesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdBulk_allowancesPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdCorrectPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdCorrectPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdChargesByChargeIdSplitPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdChargesByChargeIdSplitPost_additionalFields', i) as IDataObject;
            ...
            case 'folioactions:FinanceFolio-actionsByFolioIdPaymentsByPaymentIdSplitPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFolio_actionsByFolioIdPaymentsByPaymentIdSplitPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsGet_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsByPaymentIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsByPaymentIdGet_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsBy-terminalPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsBy_terminalPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsBy-authorizationPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsBy_authorizationPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsBy-payment-accountPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsBy_payment_accountPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsBy-linkPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsBy_linkPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdRefundsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdRefundsGet_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdRefundsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdRefundsPost_additionalFields', i) as IDataObject;
            ...
            case 'foliopayments:FinanceFoliosByFolioIdPaymentsByPaymentIdRefundsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceFoliosByFolioIdPaymentsByPaymentIdRefundsPost_additionalFields', i) as IDataObject;
            ...
            case 'invoice:FinanceInvoicesPreview-pdfGet': {
                ...
                const FinanceInvoicesPreview_pdfGet_languageCode_value = this.getNodeParameter('FinanceInvoicesPreview_pdfGet_languageCode', i);
                if (FinanceInvoicesPreview_pdfGet_languageCode_value !== undefined && FinanceInvoicesPreview_pdfGet_languageCode_value !== '' && (!Array.isArray(FinanceInvoicesPreview_pdfGet_languageCode_value) || FinanceInvoicesPreview_pdfGet_languageCode_value.length > 0)) {
                    qs['languageCode'] = FinanceInvoicesPreview_pdfGet_languageCode_value;
                }

                const FinanceInvoicesPreview_pdfGet_folioId_value = this.getNodeParameter('FinanceInvoicesPreview_pdfGet_folioId', i);
                if (FinanceInvoicesPreview_pdfGet_folioId_value !== undefined && FinanceInvoicesPreview_pdfGet_folioId_value !== '' && (!Array.isArray(FinanceInvoicesPreview_pdfGet_folioId_value) || FinanceInvoicesPreview_pdfGet_folioId_value.length > 0)) {
            ...
            case 'invoice:FinanceInvoicesPreviewGet': {
                ...
                const FinanceInvoicesPreviewGet_folioId_value = this.getNodeParameter('FinanceInvoicesPreviewGet_folioId', i);
                if (FinanceInvoicesPreviewGet_folioId_value !== undefined && FinanceInvoicesPreviewGet_folioId_value !== '' && (!Array.isArray(FinanceInvoicesPreviewGet_folioId_value) || FinanceInvoicesPreviewGet_folioId_value.length > 0)) {
                    qs['folioId'] = FinanceInvoicesPreviewGet_folioId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceInvoicesPreviewGet_additionalFields', i) as IDataObject;
            ...
            case 'invoice:FinanceInvoicesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceInvoicesGet_additionalFields', i) as IDataObject;
            ...
            case 'invoice:FinanceInvoicesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceInvoicesPost_additionalFields', i) as IDataObject;
            ...
            case 'invoice:FinanceInvoicesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceInvoicesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsAggregate-pairs-dailyPost': {
                ...
                const FinanceAccountsAggregate_pairs_dailyPost_propertyId_value = this.getNodeParameter('FinanceAccountsAggregate_pairs_dailyPost_propertyId', i);
                if (FinanceAccountsAggregate_pairs_dailyPost_propertyId_value !== undefined && FinanceAccountsAggregate_pairs_dailyPost_propertyId_value !== '' && (!Array.isArray(FinanceAccountsAggregate_pairs_dailyPost_propertyId_value) || FinanceAccountsAggregate_pairs_dailyPost_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsAggregate_pairs_dailyPost_propertyId_value;
                }

                const FinanceAccountsAggregate_pairs_dailyPost_from_value = this.getNodeParameter('FinanceAccountsAggregate_pairs_dailyPost_from', i);
                if (FinanceAccountsAggregate_pairs_dailyPost_from_value !== undefined && FinanceAccountsAggregate_pairs_dailyPost_from_value !== '' && (!Array.isArray(FinanceAccountsAggregate_pairs_dailyPost_from_value) || FinanceAccountsAggregate_pairs_dailyPost_from_value.length > 0)) {
                    qs['from'] = FinanceAccountsAggregate_pairs_dailyPost_from_value;
                }

                const FinanceAccountsAggregate_pairs_dailyPost_to_value = this.getNodeParameter('FinanceAccountsAggregate_pairs_dailyPost_to', i);
                if (FinanceAccountsAggregate_pairs_dailyPost_to_value !== undefined && FinanceAccountsAggregate_pairs_dailyPost_to_value !== '' && (!Array.isArray(FinanceAccountsAggregate_pairs_dailyPost_to_value) || FinanceAccountsAggregate_pairs_dailyPost_to_value.length > 0)) {
                    qs['to'] = FinanceAccountsAggregate_pairs_dailyPost_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsAggregate_pairs_dailyPost_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsAggregate-dailyPost': {
                ...
                const FinanceAccountsAggregate_dailyPost_propertyId_value = this.getNodeParameter('FinanceAccountsAggregate_dailyPost_propertyId', i);
                if (FinanceAccountsAggregate_dailyPost_propertyId_value !== undefined && FinanceAccountsAggregate_dailyPost_propertyId_value !== '' && (!Array.isArray(FinanceAccountsAggregate_dailyPost_propertyId_value) || FinanceAccountsAggregate_dailyPost_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsAggregate_dailyPost_propertyId_value;
                }

                const FinanceAccountsAggregate_dailyPost_from_value = this.getNodeParameter('FinanceAccountsAggregate_dailyPost_from', i);
                if (FinanceAccountsAggregate_dailyPost_from_value !== undefined && FinanceAccountsAggregate_dailyPost_from_value !== '' && (!Array.isArray(FinanceAccountsAggregate_dailyPost_from_value) || FinanceAccountsAggregate_dailyPost_from_value.length > 0)) {
                    qs['from'] = FinanceAccountsAggregate_dailyPost_from_value;
                }

                const FinanceAccountsAggregate_dailyPost_to_value = this.getNodeParameter('FinanceAccountsAggregate_dailyPost_to', i);
                if (FinanceAccountsAggregate_dailyPost_to_value !== undefined && FinanceAccountsAggregate_dailyPost_to_value !== '' && (!Array.isArray(FinanceAccountsAggregate_dailyPost_to_value) || FinanceAccountsAggregate_dailyPost_to_value.length > 0)) {
                    qs['to'] = FinanceAccountsAggregate_dailyPost_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsAggregate_dailyPost_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsAggregatePost': {
                ...
                const FinanceAccountsAggregatePost_propertyId_value = this.getNodeParameter('FinanceAccountsAggregatePost_propertyId', i);
                if (FinanceAccountsAggregatePost_propertyId_value !== undefined && FinanceAccountsAggregatePost_propertyId_value !== '' && (!Array.isArray(FinanceAccountsAggregatePost_propertyId_value) || FinanceAccountsAggregatePost_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsAggregatePost_propertyId_value;
                }

                const FinanceAccountsAggregatePost_from_value = this.getNodeParameter('FinanceAccountsAggregatePost_from', i);
                if (FinanceAccountsAggregatePost_from_value !== undefined && FinanceAccountsAggregatePost_from_value !== '' && (!Array.isArray(FinanceAccountsAggregatePost_from_value) || FinanceAccountsAggregatePost_from_value.length > 0)) {
                    qs['from'] = FinanceAccountsAggregatePost_from_value;
                }

                const FinanceAccountsAggregatePost_to_value = this.getNodeParameter('FinanceAccountsAggregatePost_to', i);
                if (FinanceAccountsAggregatePost_to_value !== undefined && FinanceAccountsAggregatePost_to_value !== '' && (!Array.isArray(FinanceAccountsAggregatePost_to_value) || FinanceAccountsAggregatePost_to_value.length > 0)) {
                    qs['to'] = FinanceAccountsAggregatePost_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsAggregatePost_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsExportPost': {
                ...
                const FinanceAccountsExportPost_propertyId_value = this.getNodeParameter('FinanceAccountsExportPost_propertyId', i);
                if (FinanceAccountsExportPost_propertyId_value !== undefined && FinanceAccountsExportPost_propertyId_value !== '' && (!Array.isArray(FinanceAccountsExportPost_propertyId_value) || FinanceAccountsExportPost_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsExportPost_propertyId_value;
                }

                const FinanceAccountsExportPost_from_value = this.getNodeParameter('FinanceAccountsExportPost_from', i);
                if (FinanceAccountsExportPost_from_value !== undefined && FinanceAccountsExportPost_from_value !== '' && (!Array.isArray(FinanceAccountsExportPost_from_value) || FinanceAccountsExportPost_from_value.length > 0)) {
                    qs['from'] = FinanceAccountsExportPost_from_value;
                }

                const FinanceAccountsExportPost_to_value = this.getNodeParameter('FinanceAccountsExportPost_to', i);
                if (FinanceAccountsExportPost_to_value !== undefined && FinanceAccountsExportPost_to_value !== '' && (!Array.isArray(FinanceAccountsExportPost_to_value) || FinanceAccountsExportPost_to_value.length > 0)) {
                    qs['to'] = FinanceAccountsExportPost_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsExportPost_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsExport-dailyPost': {
                ...
                const FinanceAccountsExport_dailyPost_propertyId_value = this.getNodeParameter('FinanceAccountsExport_dailyPost_propertyId', i);
                if (FinanceAccountsExport_dailyPost_propertyId_value !== undefined && FinanceAccountsExport_dailyPost_propertyId_value !== '' && (!Array.isArray(FinanceAccountsExport_dailyPost_propertyId_value) || FinanceAccountsExport_dailyPost_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsExport_dailyPost_propertyId_value;
                }

                const FinanceAccountsExport_dailyPost_from_value = this.getNodeParameter('FinanceAccountsExport_dailyPost_from', i);
                if (FinanceAccountsExport_dailyPost_from_value !== undefined && FinanceAccountsExport_dailyPost_from_value !== '' && (!Array.isArray(FinanceAccountsExport_dailyPost_from_value) || FinanceAccountsExport_dailyPost_from_value.length > 0)) {
                    qs['from'] = FinanceAccountsExport_dailyPost_from_value;
                }

                const FinanceAccountsExport_dailyPost_to_value = this.getNodeParameter('FinanceAccountsExport_dailyPost_to', i);
                if (FinanceAccountsExport_dailyPost_to_value !== undefined && FinanceAccountsExport_dailyPost_to_value !== '' && (!Array.isArray(FinanceAccountsExport_dailyPost_to_value) || FinanceAccountsExport_dailyPost_to_value.length > 0)) {
                    qs['to'] = FinanceAccountsExport_dailyPost_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsExport_dailyPost_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsExport-gross-dailyPost': {
                ...
                const FinanceAccountsExport_gross_dailyPost_propertyId_value = this.getNodeParameter('FinanceAccountsExport_gross_dailyPost_propertyId', i);
                if (FinanceAccountsExport_gross_dailyPost_propertyId_value !== undefined && FinanceAccountsExport_gross_dailyPost_propertyId_value !== '' && (!Array.isArray(FinanceAccountsExport_gross_dailyPost_propertyId_value) || FinanceAccountsExport_gross_dailyPost_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsExport_gross_dailyPost_propertyId_value;
                }

                const FinanceAccountsExport_gross_dailyPost_from_value = this.getNodeParameter('FinanceAccountsExport_gross_dailyPost_from', i);
                if (FinanceAccountsExport_gross_dailyPost_from_value !== undefined && FinanceAccountsExport_gross_dailyPost_from_value !== '' && (!Array.isArray(FinanceAccountsExport_gross_dailyPost_from_value) || FinanceAccountsExport_gross_dailyPost_from_value.length > 0)) {
                    qs['from'] = FinanceAccountsExport_gross_dailyPost_from_value;
                }

                const FinanceAccountsExport_gross_dailyPost_to_value = this.getNodeParameter('FinanceAccountsExport_gross_dailyPost_to', i);
                if (FinanceAccountsExport_gross_dailyPost_to_value !== undefined && FinanceAccountsExport_gross_dailyPost_to_value !== '' && (!Array.isArray(FinanceAccountsExport_gross_dailyPost_to_value) || FinanceAccountsExport_gross_dailyPost_to_value.length > 0)) {
                    qs['to'] = FinanceAccountsExport_gross_dailyPost_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsExport_gross_dailyPost_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsSchemaGet': {
                ...
                const FinanceAccountsSchemaGet_propertyId_value = this.getNodeParameter('FinanceAccountsSchemaGet_propertyId', i);
                if (FinanceAccountsSchemaGet_propertyId_value !== undefined && FinanceAccountsSchemaGet_propertyId_value !== '' && (!Array.isArray(FinanceAccountsSchemaGet_propertyId_value) || FinanceAccountsSchemaGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsSchemaGet_propertyId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsSchemaGet_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceGlobal-accountsGet': {
                ...
                const FinanceGlobal_accountsGet_propertyId_value = this.getNodeParameter('FinanceGlobal_accountsGet_propertyId', i);
                if (FinanceGlobal_accountsGet_propertyId_value !== undefined && FinanceGlobal_accountsGet_propertyId_value !== '' && (!Array.isArray(FinanceGlobal_accountsGet_propertyId_value) || FinanceGlobal_accountsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceGlobal_accountsGet_propertyId_value;
                }

                const FinanceGlobal_accountsGet_parent_value = this.getNodeParameter('FinanceGlobal_accountsGet_parent', i);
                if (FinanceGlobal_accountsGet_parent_value !== undefined && FinanceGlobal_accountsGet_parent_value !== '' && (!Array.isArray(FinanceGlobal_accountsGet_parent_value) || FinanceGlobal_accountsGet_parent_value.length > 0)) {
                    qs['parent'] = FinanceGlobal_accountsGet_parent_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceGlobal_accountsGet_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceGuest-accountsGet': {
                ...
                const FinanceGuest_accountsGet_propertyId_value = this.getNodeParameter('FinanceGuest_accountsGet_propertyId', i);
                if (FinanceGuest_accountsGet_propertyId_value !== undefined && FinanceGuest_accountsGet_propertyId_value !== '' && (!Array.isArray(FinanceGuest_accountsGet_propertyId_value) || FinanceGuest_accountsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceGuest_accountsGet_propertyId_value;
                }

                const FinanceGuest_accountsGet_reservationId_value = this.getNodeParameter('FinanceGuest_accountsGet_reservationId', i);
                if (FinanceGuest_accountsGet_reservationId_value !== undefined && FinanceGuest_accountsGet_reservationId_value !== '' && (!Array.isArray(FinanceGuest_accountsGet_reservationId_value) || FinanceGuest_accountsGet_reservationId_value.length > 0)) {
                    qs['reservationId'] = FinanceGuest_accountsGet_reservationId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceGuest_accountsGet_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceExternal-accountsGet': {
                ...
                const FinanceExternal_accountsGet_propertyId_value = this.getNodeParameter('FinanceExternal_accountsGet_propertyId', i);
                if (FinanceExternal_accountsGet_propertyId_value !== undefined && FinanceExternal_accountsGet_propertyId_value !== '' && (!Array.isArray(FinanceExternal_accountsGet_propertyId_value) || FinanceExternal_accountsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceExternal_accountsGet_propertyId_value;
                }

                const FinanceExternal_accountsGet_folioId_value = this.getNodeParameter('FinanceExternal_accountsGet_folioId', i);
                if (FinanceExternal_accountsGet_folioId_value !== undefined && FinanceExternal_accountsGet_folioId_value !== '' && (!Array.isArray(FinanceExternal_accountsGet_folioId_value) || FinanceExternal_accountsGet_folioId_value.length > 0)) {
                    qs['folioId'] = FinanceExternal_accountsGet_folioId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceExternal_accountsGet_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsByNumberGet': {
                ...
                const FinanceAccountsByNumberGet_propertyId_value = this.getNodeParameter('FinanceAccountsByNumberGet_propertyId', i);
                if (FinanceAccountsByNumberGet_propertyId_value !== undefined && FinanceAccountsByNumberGet_propertyId_value !== '' && (!Array.isArray(FinanceAccountsByNumberGet_propertyId_value) || FinanceAccountsByNumberGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsByNumberGet_propertyId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsByNumberGet_additionalFields', i) as IDataObject;
            ...
            case 'subledger:FinanceAccountsChild-accountsGet': {
                ...
                const FinanceAccountsChild_accountsGet_propertyId_value = this.getNodeParameter('FinanceAccountsChild_accountsGet_propertyId', i);
                if (FinanceAccountsChild_accountsGet_propertyId_value !== undefined && FinanceAccountsChild_accountsGet_propertyId_value !== '' && (!Array.isArray(FinanceAccountsChild_accountsGet_propertyId_value) || FinanceAccountsChild_accountsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = FinanceAccountsChild_accountsGet_propertyId_value;
                }

                const FinanceAccountsChild_accountsGet_parent_value = this.getNodeParameter('FinanceAccountsChild_accountsGet_parent', i);
                if (FinanceAccountsChild_accountsGet_parent_value !== undefined && FinanceAccountsChild_accountsGet_parent_value !== '' && (!Array.isArray(FinanceAccountsChild_accountsGet_parent_value) || FinanceAccountsChild_accountsGet_parent_value.length > 0)) {
                    qs['parent'] = FinanceAccountsChild_accountsGet_parent_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceAccountsChild_accountsGet_additionalFields', i) as IDataObject;
            ...
            case 'types:FinanceTypesVatGet': {
                ...
                const FinanceTypesVatGet_isoCountryCode_value = this.getNodeParameter('FinanceTypesVatGet_isoCountryCode', i);
                if (FinanceTypesVatGet_isoCountryCode_value !== undefined && FinanceTypesVatGet_isoCountryCode_value !== '' && (!Array.isArray(FinanceTypesVatGet_isoCountryCode_value) || FinanceTypesVatGet_isoCountryCode_value.length > 0)) {
                    qs['isoCountryCode'] = FinanceTypesVatGet_isoCountryCode_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('FinanceTypesVatGet_additionalFields', i) as IDataObject;
            ...
            case 'property:InventoryPropertiesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryPropertiesGet_additionalFields', i) as IDataObject;
            ...
            case 'property:InventoryPropertiesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryPropertiesPost_additionalFields', i) as IDataObject;
            ...
            case 'property:InventoryPropertiesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryPropertiesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'unit:InventoryUnitsByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnitsByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'unit:InventoryUnitsPatch': {
                ...
                const InventoryUnitsPatch_unitIds_value = this.getNodeParameter('InventoryUnitsPatch_unitIds', i);
                if (InventoryUnitsPatch_unitIds_value !== undefined && InventoryUnitsPatch_unitIds_value !== '' && (!Array.isArray(InventoryUnitsPatch_unitIds_value) || InventoryUnitsPatch_unitIds_value.length > 0)) {
            ...
            case 'unit:InventoryUnitsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnitsGet_additionalFields', i) as IDataObject;
            ...
            case 'unit:InventoryUnitsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnitsPost_additionalFields', i) as IDataObject;
            ...
            case 'unit:InventoryUnits$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnits_countGet_additionalFields', i) as IDataObject;
            ...
            case 'unit:InventoryUnitsBulkPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnitsBulkPost_additionalFields', i) as IDataObject;
            ...
            case 'unitattribute:InventoryUnit-attributesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnit_attributesGet_additionalFields', i) as IDataObject;
            ...
            case 'unitattribute:InventoryUnit-attributesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnit_attributesPost_additionalFields', i) as IDataObject;
            ...
            case 'unitgroup:InventoryUnit-groupsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnit_groupsPost_additionalFields', i) as IDataObject;
            ...
            case 'unitgroup:InventoryUnit-groupsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnit_groupsGet_additionalFields', i) as IDataObject;
            ...
            case 'unitgroup:InventoryUnit-groups$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnit_groups_countGet_additionalFields', i) as IDataObject;
            ...
            case 'unitgroup:InventoryUnit-groupsByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('InventoryUnit_groupsByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'bookinglogs:LogsBookingReservationGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('LogsBookingReservationGet_additionalFields', i) as IDataObject;
            ...
            case 'financelogs:LogsFinanceFolioGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('LogsFinanceFolioGet_additionalFields', i) as IDataObject;
            ...
            case 'financelogs:LogsFinanceNight-auditGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('LogsFinanceNight_auditGet_additionalFields', i) as IDataObject;
            ...
            case 'financelogs:LogsFinanceTransactions-exportGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('LogsFinanceTransactions_exportGet_additionalFields', i) as IDataObject;
            ...
            case 'maintenance:OperationsMaintenancesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('OperationsMaintenancesGet_additionalFields', i) as IDataObject;
            ...
            case 'maintenance:OperationsMaintenancesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('OperationsMaintenancesPost_additionalFields', i) as IDataObject;
            ...
            case 'maintenance:OperationsMaintenances$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('OperationsMaintenances_countGet_additionalFields', i) as IDataObject;
            ...
            case 'maintenance:OperationsMaintenancesBulkPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('OperationsMaintenancesBulkPost_additionalFields', i) as IDataObject;
            ...
            case 'maintenance:OperationsMaintenancesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('OperationsMaintenancesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'operations:OperationsNight-auditPut': {
                ...
                const OperationsNight_auditPut_propertyId_value = this.getNodeParameter('OperationsNight_auditPut_propertyId', i);
                if (OperationsNight_auditPut_propertyId_value !== undefined && OperationsNight_auditPut_propertyId_value !== '' && (!Array.isArray(OperationsNight_auditPut_propertyId_value) || OperationsNight_auditPut_propertyId_value.length > 0)) {
                    qs['propertyId'] = OperationsNight_auditPut_propertyId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('OperationsNight_auditPut_additionalFields', i) as IDataObject;
            ...
            case 'agecategory:SettingsAge-categoriesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsAge_categoriesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'agecategory:SettingsAge-categoriesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsAge_categoriesPost_additionalFields', i) as IDataObject;
            ...
            case 'agecategory:SettingsAge-categoriesGet': {
                ...
                const SettingsAge_categoriesGet_propertyId_value = this.getNodeParameter('SettingsAge_categoriesGet_propertyId', i);
                if (SettingsAge_categoriesGet_propertyId_value !== undefined && SettingsAge_categoriesGet_propertyId_value !== '' && (!Array.isArray(SettingsAge_categoriesGet_propertyId_value) || SettingsAge_categoriesGet_propertyId_value.length > 0)) {
            ...
            case 'cancellationpolicy:RateplanCancellation-policiesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanCancellation_policiesPost_additionalFields', i) as IDataObject;
            ...
            case 'cancellationpolicy:RateplanCancellation-policiesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanCancellation_policiesGet_additionalFields', i) as IDataObject;
            ...
            case 'cancellationpolicy:RateplanCancellation-policiesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanCancellation_policiesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'company:RateplanCompaniesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanCompaniesPost_additionalFields', i) as IDataObject;
            ...
            case 'company:RateplanCompaniesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanCompaniesGet_additionalFields', i) as IDataObject;
            ...
            case 'corporatecodes:RateplanCorporate-codesCodesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanCorporate_codesCodesGet_additionalFields', i) as IDataObject;
            ...
            case 'noshowpolicy:RateplanNo-show-policiesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanNo_show_policiesPost_additionalFields', i) as IDataObject;
            ...
            case 'noshowpolicy:RateplanNo-show-policiesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanNo_show_policiesGet_additionalFields', i) as IDataObject;
            ...
            case 'noshowpolicy:RateplanNo-show-policiesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanNo_show_policiesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'promocodes:RateplanPromo-codesCodesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanPromo_codesCodesGet_additionalFields', i) as IDataObject;
            ...
            case 'rate:RateplanRate-plansByIdRatesGet': {
                ...
                const RateplanRate_plansByIdRatesGet_from_value = this.getNodeParameter('RateplanRate_plansByIdRatesGet_from', i);
                if (RateplanRate_plansByIdRatesGet_from_value !== undefined && RateplanRate_plansByIdRatesGet_from_value !== '' && (!Array.isArray(RateplanRate_plansByIdRatesGet_from_value) || RateplanRate_plansByIdRatesGet_from_value.length > 0)) {
                    qs['from'] = RateplanRate_plansByIdRatesGet_from_value;
                }

                const RateplanRate_plansByIdRatesGet_to_value = this.getNodeParameter('RateplanRate_plansByIdRatesGet_to', i);
                if (RateplanRate_plansByIdRatesGet_to_value !== undefined && RateplanRate_plansByIdRatesGet_to_value !== '' && (!Array.isArray(RateplanRate_plansByIdRatesGet_to_value) || RateplanRate_plansByIdRatesGet_to_value.length > 0)) {
                    qs['to'] = RateplanRate_plansByIdRatesGet_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanRate_plansByIdRatesGet_additionalFields', i) as IDataObject;
            ...
            case 'rate:RateplanRatesPatch': {
                ...
                const RateplanRatesPatch_ratePlanIds_value = this.getNodeParameter('RateplanRatesPatch_ratePlanIds', i);
                if (RateplanRatesPatch_ratePlanIds_value !== undefined && RateplanRatesPatch_ratePlanIds_value !== '' && (!Array.isArray(RateplanRatesPatch_ratePlanIds_value) || RateplanRatesPatch_ratePlanIds_value.length > 0)) {
                    qs['ratePlanIds'] = RateplanRatesPatch_ratePlanIds_value;
                }

                const RateplanRatesPatch_from_value = this.getNodeParameter('RateplanRatesPatch_from', i);
                if (RateplanRatesPatch_from_value !== undefined && RateplanRatesPatch_from_value !== '' && (!Array.isArray(RateplanRatesPatch_from_value) || RateplanRatesPatch_from_value.length > 0)) {
                    qs['from'] = RateplanRatesPatch_from_value;
                }

                const RateplanRatesPatch_to_value = this.getNodeParameter('RateplanRatesPatch_to', i);
                if (RateplanRatesPatch_to_value !== undefined && RateplanRatesPatch_to_value !== '' && (!Array.isArray(RateplanRatesPatch_to_value) || RateplanRatesPatch_to_value.length > 0)) {
                    qs['to'] = RateplanRatesPatch_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanRatesPatch_additionalFields', i) as IDataObject;
            ...
            case 'rateplan:RateplanRate-plansGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanRate_plansGet_additionalFields', i) as IDataObject;
            ...
            case 'rateplan:RateplanRate-plansPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanRate_plansPost_additionalFields', i) as IDataObject;
            ...
            case 'rateplan:RateplanRate-plansPatch': {
                ...
                const RateplanRate_plansPatch_ratePlanIds_value = this.getNodeParameter('RateplanRate_plansPatch_ratePlanIds', i);
                if (RateplanRate_plansPatch_ratePlanIds_value !== undefined && RateplanRate_plansPatch_ratePlanIds_value !== '' && (!Array.isArray(RateplanRate_plansPatch_ratePlanIds_value) || RateplanRate_plansPatch_ratePlanIds_value.length > 0)) {
            ...
            case 'rateplan:RateplanRate-plansByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanRate_plansByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'service:RateplanServicesPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanServicesPost_additionalFields', i) as IDataObject;
            ...
            case 'service:RateplanServicesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanServicesGet_additionalFields', i) as IDataObject;
            ...
            case 'service:RateplanServicesByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('RateplanServicesByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'reports:ReportsReportsOrdered-servicesGet': {
                ...
                const ReportsReportsOrdered_servicesGet_propertyId_value = this.getNodeParameter('ReportsReportsOrdered_servicesGet_propertyId', i);
                if (ReportsReportsOrdered_servicesGet_propertyId_value !== undefined && ReportsReportsOrdered_servicesGet_propertyId_value !== '' && (!Array.isArray(ReportsReportsOrdered_servicesGet_propertyId_value) || ReportsReportsOrdered_servicesGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = ReportsReportsOrdered_servicesGet_propertyId_value;
                }

                const ReportsReportsOrdered_servicesGet_serviceIds_value = this.getNodeParameter('ReportsReportsOrdered_servicesGet_serviceIds', i);
                if (ReportsReportsOrdered_servicesGet_serviceIds_value !== undefined && ReportsReportsOrdered_servicesGet_serviceIds_value !== '' && (!Array.isArray(ReportsReportsOrdered_servicesGet_serviceIds_value) || ReportsReportsOrdered_servicesGet_serviceIds_value.length > 0)) {
                    qs['serviceIds'] = ReportsReportsOrdered_servicesGet_serviceIds_value;
                }

                const ReportsReportsOrdered_servicesGet_from_value = this.getNodeParameter('ReportsReportsOrdered_servicesGet_from', i);
                if (ReportsReportsOrdered_servicesGet_from_value !== undefined && ReportsReportsOrdered_servicesGet_from_value !== '' && (!Array.isArray(ReportsReportsOrdered_servicesGet_from_value) || ReportsReportsOrdered_servicesGet_from_value.length > 0)) {
                    qs['from'] = ReportsReportsOrdered_servicesGet_from_value;
                }

                const ReportsReportsOrdered_servicesGet_to_value = this.getNodeParameter('ReportsReportsOrdered_servicesGet_to', i);
                if (ReportsReportsOrdered_servicesGet_to_value !== undefined && ReportsReportsOrdered_servicesGet_to_value !== '' && (!Array.isArray(ReportsReportsOrdered_servicesGet_to_value) || ReportsReportsOrdered_servicesGet_to_value.length > 0)) {
            ...
            case 'reports:ReportsReportsArrivalsGet': {
                ...
                const ReportsReportsArrivalsGet_propertyId_value = this.getNodeParameter('ReportsReportsArrivalsGet_propertyId', i);
                if (ReportsReportsArrivalsGet_propertyId_value !== undefined && ReportsReportsArrivalsGet_propertyId_value !== '' && (!Array.isArray(ReportsReportsArrivalsGet_propertyId_value) || ReportsReportsArrivalsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = ReportsReportsArrivalsGet_propertyId_value;
                }

                const ReportsReportsArrivalsGet_month_value = this.getNodeParameter('ReportsReportsArrivalsGet_month', i);
                if (ReportsReportsArrivalsGet_month_value !== undefined && ReportsReportsArrivalsGet_month_value !== '' && (!Array.isArray(ReportsReportsArrivalsGet_month_value) || ReportsReportsArrivalsGet_month_value.length > 0)) {
                    qs['month'] = ReportsReportsArrivalsGet_month_value;
                }

                const ReportsReportsArrivalsGet_year_value = this.getNodeParameter('ReportsReportsArrivalsGet_year', i);
                if (ReportsReportsArrivalsGet_year_value !== undefined && ReportsReportsArrivalsGet_year_value !== '' && (!Array.isArray(ReportsReportsArrivalsGet_year_value) || ReportsReportsArrivalsGet_year_value.length > 0)) {
            ...
            case 'reports:ReportsReportsProperty-performanceGet': {
                ...
                const ReportsReportsProperty_performanceGet_propertyId_value = this.getNodeParameter('ReportsReportsProperty_performanceGet_propertyId', i);
                if (ReportsReportsProperty_performanceGet_propertyId_value !== undefined && ReportsReportsProperty_performanceGet_propertyId_value !== '' && (!Array.isArray(ReportsReportsProperty_performanceGet_propertyId_value) || ReportsReportsProperty_performanceGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = ReportsReportsProperty_performanceGet_propertyId_value;
                }

                const ReportsReportsProperty_performanceGet_from_value = this.getNodeParameter('ReportsReportsProperty_performanceGet_from', i);
                if (ReportsReportsProperty_performanceGet_from_value !== undefined && ReportsReportsProperty_performanceGet_from_value !== '' && (!Array.isArray(ReportsReportsProperty_performanceGet_from_value) || ReportsReportsProperty_performanceGet_from_value.length > 0)) {
                    qs['from'] = ReportsReportsProperty_performanceGet_from_value;
                }

                const ReportsReportsProperty_performanceGet_to_value = this.getNodeParameter('ReportsReportsProperty_performanceGet_to', i);
                if (ReportsReportsProperty_performanceGet_to_value !== undefined && ReportsReportsProperty_performanceGet_to_value !== '' && (!Array.isArray(ReportsReportsProperty_performanceGet_to_value) || ReportsReportsProperty_performanceGet_to_value.length > 0)) {
                    qs['to'] = ReportsReportsProperty_performanceGet_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('ReportsReportsProperty_performanceGet_additionalFields', i) as IDataObject;
            ...
            case 'reports:ReportsReportsCompany-invoices-vatGet': {
                ...
                const ReportsReportsCompany_invoices_vatGet_propertyId_value = this.getNodeParameter('ReportsReportsCompany_invoices_vatGet_propertyId', i);
                if (ReportsReportsCompany_invoices_vatGet_propertyId_value !== undefined && ReportsReportsCompany_invoices_vatGet_propertyId_value !== '' && (!Array.isArray(ReportsReportsCompany_invoices_vatGet_propertyId_value) || ReportsReportsCompany_invoices_vatGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = ReportsReportsCompany_invoices_vatGet_propertyId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('ReportsReportsCompany_invoices_vatGet_additionalFields', i) as IDataObject;
            ...
            case 'reports:ReportsReportsRevenuesGet': {
                ...
                const ReportsReportsRevenuesGet_propertyId_value = this.getNodeParameter('ReportsReportsRevenuesGet_propertyId', i);
                if (ReportsReportsRevenuesGet_propertyId_value !== undefined && ReportsReportsRevenuesGet_propertyId_value !== '' && (!Array.isArray(ReportsReportsRevenuesGet_propertyId_value) || ReportsReportsRevenuesGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = ReportsReportsRevenuesGet_propertyId_value;
                }

                const ReportsReportsRevenuesGet_from_value = this.getNodeParameter('ReportsReportsRevenuesGet_from', i);
                if (ReportsReportsRevenuesGet_from_value !== undefined && ReportsReportsRevenuesGet_from_value !== '' && (!Array.isArray(ReportsReportsRevenuesGet_from_value) || ReportsReportsRevenuesGet_from_value.length > 0)) {
                    qs['from'] = ReportsReportsRevenuesGet_from_value;
                }

                const ReportsReportsRevenuesGet_to_value = this.getNodeParameter('ReportsReportsRevenuesGet_to', i);
                if (ReportsReportsRevenuesGet_to_value !== undefined && ReportsReportsRevenuesGet_to_value !== '' && (!Array.isArray(ReportsReportsRevenuesGet_to_value) || ReportsReportsRevenuesGet_to_value.length > 0)) {
                    qs['to'] = ReportsReportsRevenuesGet_to_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('ReportsReportsRevenuesGet_additionalFields', i) as IDataObject;
            ...
            case 'capturepolicies:SettingsCapture-policiesGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsCapture_policiesGet_additionalFields', i) as IDataObject;
            ...
            case 'citytax:SettingsCity-taxPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsCity_taxPost_additionalFields', i) as IDataObject;
            ...
            case 'citytax:SettingsCity-taxGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsCity_taxGet_additionalFields', i) as IDataObject;
            ...
            case 'citytax:SettingsCity-taxByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsCity_taxByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'customsubaccounts:SettingsSub-accountsGet': {
                ...
                const SettingsSub_accountsGet_propertyId_value = this.getNodeParameter('SettingsSub_accountsGet_propertyId', i);
                if (SettingsSub_accountsGet_propertyId_value !== undefined && SettingsSub_accountsGet_propertyId_value !== '' && (!Array.isArray(SettingsSub_accountsGet_propertyId_value) || SettingsSub_accountsGet_propertyId_value.length > 0)) {
                    qs['propertyId'] = SettingsSub_accountsGet_propertyId_value;
                }

                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsSub_accountsGet_additionalFields', i) as IDataObject;
            ...
            case 'customsubaccounts:SettingsSub-accountsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsSub_accountsPost_additionalFields', i) as IDataObject;
            ...
            case 'customsubaccounts:SettingsSub-accounts$countGet': {
                ...
                const SettingsSub_accounts_countGet_propertyId_value = this.getNodeParameter('SettingsSub_accounts_countGet_propertyId', i);
                if (SettingsSub_accounts_countGet_propertyId_value !== undefined && SettingsSub_accounts_countGet_propertyId_value !== '' && (!Array.isArray(SettingsSub_accounts_countGet_propertyId_value) || SettingsSub_accounts_countGet_propertyId_value.length > 0)) {
            ...
            case 'invoiceaddress:SettingsInvoice-addressGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsInvoice_addressGet_additionalFields', i) as IDataObject;
            ...
            case 'invoiceaddress:SettingsInvoice-addressPut': {
                ...
                const SettingsInvoice_addressPut_propertyIds_value = this.getNodeParameter('SettingsInvoice_addressPut_propertyIds', i);
                if (SettingsInvoice_addressPut_propertyIds_value !== undefined && SettingsInvoice_addressPut_propertyIds_value !== '' && (!Array.isArray(SettingsInvoice_addressPut_propertyIds_value) || SettingsInvoice_addressPut_propertyIds_value.length > 0)) {
            ...
            case 'invoiceaddress:SettingsInvoice-addressPatch': {
                ...
                const SettingsInvoice_addressPatch_propertyIds_value = this.getNodeParameter('SettingsInvoice_addressPatch_propertyIds', i);
                if (SettingsInvoice_addressPatch_propertyIds_value !== undefined && SettingsInvoice_addressPatch_propertyIds_value !== '' && (!Array.isArray(SettingsInvoice_addressPatch_propertyIds_value) || SettingsInvoice_addressPatch_propertyIds_value.length > 0)) {
            ...
            case 'marketsegment:SettingsMarket-segmentsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsMarket_segmentsGet_additionalFields', i) as IDataObject;
            ...
            case 'marketsegment:SettingsMarket-segmentsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsMarket_segmentsPost_additionalFields', i) as IDataObject;
            ...
            case 'marketsegment:SettingsMarket-segments$countGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsMarket_segments_countGet_additionalFields', i) as IDataObject;
            ...
            case 'timeslicedefinitions:SettingsPropertiesByPropertyIdTime-slice-definitionsByIdGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsPropertiesByPropertyIdTime_slice_definitionsByIdGet_additionalFields', i) as IDataObject;
            ...
            case 'timeslicedefinitions:SettingsPropertiesByPropertyIdTime-slice-definitionsGet': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsPropertiesByPropertyIdTime_slice_definitionsGet_additionalFields', i) as IDataObject;
            ...
            case 'timeslicedefinitions:SettingsPropertiesByPropertyIdTime-slice-definitionsPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('SettingsPropertiesByPropertyIdTime_slice_definitionsPost_additionalFields', i) as IDataObject;
            ...
            case 'healthcheck:PingerPost': {
                ...
                // Get additionalFields for optional parameters
                const additionalFields = this.getNodeParameter('PingerPost_additionalFields', i) as IDataObject;
