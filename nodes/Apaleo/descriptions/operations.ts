...
export const operationsByResource = {
	account: [
		...
		{
			displayName: 'Replaces an existing account.',
			value: 'AccountAccountsCurrentPut',
			description:
			...
			action: 'Replaces an existing account.',
			method: 'PUT',
			path: '/account/v1/accounts/current',
			resource: 'account',
			group: 'account-v1',
		...
		{
			displayName: 'Creates an account with an admin user.',
			value: 'AccountAccountsPost',
			description:
				"Use this call to create a new account.<br>You must have this scope: 'account.create'.",
			action: 'Creates an account with an admin user.',
			method: 'POST',
			path: '/account/v1/accounts',
			resource: 'account',
			group: 'account-v1',
	...
	accountactions: [
		{
			displayName: 'Suspend the account.',
			value: 'AccountAccount-actionsCurrentSuspendPut',
			description:
				"Suspends the current account.\r\nThis changes the account type to 'Suspended'.<br>You must have this scope: 'account.manage'.",
			action: 'Suspend the account.',
			method: 'PUT',
			path: '/account/v1/account-actions/current/suspend',
			resource: 'accountactions',
			group: 'account-v1',
		},
		{
			displayName: 'Move the account to live.',
			value: 'AccountAccount-actionsCurrentSet-livePut',
			description:
				"Move the current account to live.\r\nThis changes the account type to 'Live'.<br>You must have this scope: 'account.manage'.",
			action: 'Move the account to live.',
			method: 'PUT',
			path: '/account/v1/account-actions/current/set-live',
			resource: 'accountactions',
			group: 'account-v1',
		},
	],
	...
	block: [
		...
		{
			displayName: 'Delete a specific block',
			value: 'BookingBlocksByIdDelete',
			description:
			...
			action: 'Delete a specific block',
			method: 'DELETE',
			path: '/booking/v1/blocks/{id}',
			resource: 'block',
			group: 'booking-v1',
		...
		{
			displayName: 'Check if a block exists',
			value: 'BookingBlocksByIdHead',
			description:
			...
			action: 'Check if a block exists',
			method: 'HEAD',
			path: '/booking/v1/blocks/{id}',
			resource: 'block',
			group: 'booking-v1',
	...
	group: [
		...
		{
			displayName: 'Delete a certain group booking',
			value: 'BookingGroupsByIdDelete',
			description:
			...
			action: 'Delete a certain group booking',
			method: 'DELETE',
			path: '/booking/v1/groups/{id}',
			resource: 'group',
			group: 'booking-v1',
		...
		{
			displayName: 'Check if a certain group booking exists',
			value: 'BookingGroupsByIdHead',
			description:
			...
			action: 'Check if a certain group booking exists',
			method: 'HEAD',
			path: '/booking/v1/groups/{id}',
			resource: 'group',
			group: 'booking-v1',
		...
		{
			displayName: 'Returns number of group bookings',
			value: 'BookingGroups$countGet',
			description:
			...
			action: 'Returns number of group bookings',
			method: 'GET',
	...
	reservationactions: [
		...
		{
			displayName: 'Lock unit assignment for a reservation.',
			value: 'BookingReservation-actionsByIdLock-unitPut',
			description:
				"Lock unit assignment for a reservation and prevent modification.\r\nIt will fail for reservations not in status 'Confirmed' or 'InHouse'.\r\nIt will also fail if Units have not been assigned to this reservation.<br>You must have this scope: 'reservations.manage'.",
			action: 'Lock unit assignment for a reservation.',
			method: 'PUT',
			path: '/booking/v1/reservation-actions/{id}/lock-unit',
			resource: 'reservationactions',
			group: 'booking-v1',
		},
		{
			displayName: 'Unlock unit assignment for a reservation.',
			value: 'BookingReservation-actionsByIdUnlock-unitPut',
			description:
				"Unlock unit assignment for a reservation and allow modification.\r\nIt will fail if the reservation is not locked.<br>You must have this scope: 'reservations.manage'.",
			action: 'Unlock unit assignment for a reservation.',
			method: 'PUT',
			path: '/booking/v1/reservation-actions/{id}/unlock-unit',
			resource: 'reservationactions',
			group: 'booking-v1',
		},
	],
	types: [
		...
		{
			displayName: 'Returns a list of supported countries.',
			value: 'InventoryTypesCountriesGet',
			description:
			...
			action: 'Returns a list of supported countries.',
			method: 'GET',
	...
	folio: [
		...
		{
			displayName: 'Deletes a folio.',
			value: 'FinanceFoliosByIdDelete',
			description:
	...
	uiintegrations: [
		{
			displayName: 'IntegrationUi-integrationsGet',
			value: 'IntegrationUi-integrationsGet',
			description: "<br>You must have this scope: 'integration:ui-integrations.manage'.",
			action: 'IntegrationUi-integrationsGet',
			method: 'GET',
			path: '/integration/v1/ui-integrations',
			resource: 'uiintegrations',
			group: 'integration-v1',
		},
		{
			displayName: 'IntegrationUi-integrationsByTargetByIdGet',
			value: 'IntegrationUi-integrationsByTargetByIdGet',
			description: "<br>You must have this scope: 'integration:ui-integrations.manage'.",
			action: 'IntegrationUi-integrationsByTargetByIdGet',
			method: 'GET',
		...
		{
			displayName: 'IntegrationUi-integrationsByTargetByIdPut',
			value: 'IntegrationUi-integrationsByTargetByIdPut',
			description: "<br>You must have this scope: 'integration:ui-integrations.manage'.",
			action: 'IntegrationUi-integrationsByTargetByIdPut',
			method: 'PUT',
			path: '/integration/v1/ui-integrations/{target}/{id}',
			resource: 'uiintegrations',
			group: 'integration-v1',
		...
		{
			displayName: 'IntegrationUi-integrationsByTargetByIdDelete',
			value: 'IntegrationUi-integrationsByTargetByIdDelete',
			description: "<br>You must have this scope: 'integration:ui-integrations.manage'.",
			action: 'IntegrationUi-integrationsByTargetByIdDelete',
			method: 'DELETE',
			path: '/integration/v1/ui-integrations/{target}/{id}',
			resource: 'uiintegrations',
			group: 'integration-v1',
		...
		{
			displayName: 'IntegrationUi-integrationsByTargetGet',
			value: 'IntegrationUi-integrationsByTargetGet',
			description: "<br>You must have this scope: 'integration:ui-integrations.manage'.",
			action: 'IntegrationUi-integrationsByTargetGet',
			method: 'GET',
		...
		{
			displayName: 'IntegrationUi-integrationsByTargetPost',
			value: 'IntegrationUi-integrationsByTargetPost',
			description: "<br>You must have this scope: 'integration:ui-integrations.manage'.",
			action: 'IntegrationUi-integrationsByTargetPost',
			method: 'POST',
			path: '/integration/v1/ui-integrations/{target}',
			resource: 'uiintegrations',
			group: 'integration-v1',
		...
		{
			displayName: 'Tests a private source integration.',
			value: 'IntegrationUi-integrationsByTargetById$testGet',
			description:
			...
			action: 'Tests a private source integration.',
			method: 'GET',
	...
	property: [
		...
		{
			displayName: 'Return total count of properties',
			value: 'InventoryProperties$countGet',
			description:
				'Return total count of properties<br>You need to be authorized (no particular scope required)',
			action: 'Return total count of properties',
			method: 'GET',
		...
		{
			displayName: 'Check if a property exists',
			value: 'InventoryPropertiesByIdHead',
			description:
				'Check if a property exists by id.<br>You need to be authorized (no particular scope required)',
			action: 'Check if a property exists',
			method: 'HEAD',
	...
	propertyactions: [
		{
			displayName: 'Clones a property',
			value: 'InventoryProperty-actionsByIdClonePost',
			description:
			...
			action: 'Clones a property',
			method: 'POST',
			path: '/inventory/v1/property-actions/{id}/clone',
			resource: 'propertyactions',
			group: 'inventory-v1',
		},
		{
			displayName: 'Archive a property',
			value: 'InventoryProperty-actionsByIdArchivePut',
			description:
		...
		{
			displayName: 'Move property to live',
			value: 'InventoryProperty-actionsByIdSet-livePut',
			description:
		...
		{
			displayName: 'Reset a test property and delete all transactional data',
			value: 'InventoryProperty-actionsByIdResetPut',
			description:
			...
			action: 'Reset a test property and delete all transactional data',
			method: 'PUT',
	...
	unitattribute: [
		...
		{
			displayName: 'Deletes unit attribute',
			value: 'InventoryUnit-attributesByIdDelete',
			description:
				"Deletes unit attribute<br>You must have at least one of these scopes: 'unitattributes.delete, setup.manage'.",
			action: 'Deletes unit attribute',
			method: 'DELETE',
			path: '/inventory/v1/unit-attributes/{id}',
			resource: 'unitattribute',
			group: 'inventory-v1',
	...
	agecategory: [
		...
		{
			displayName: 'Delete an age category',
			value: 'SettingsAge-categoriesByIdDelete',
			description:
				"Use this call to delete an age category. You can only delete an age category if it is not already used in a rate\r\nplan to define age specific prices.\n<br>You must have at least one of these scopes: 'settings.manage, setup.manage'.",
			action: 'Delete an age category',
			method: 'DELETE',
			path: '/settings/v1/age-categories/{id}',
			resource: 'agecategory',
			group: 'rateplan-v1',
	...
	cancellationpolicy: [
		...
		{
			displayName: 'Delete a cancellation policy',
			value: 'RateplanCancellation-policiesByIdDelete',
			description:
				"Use this call to delete a cancellation policy.<br>You must have this scope: 'setup.manage'.",
			action: 'Delete a cancellation policy',
			method: 'DELETE',
			path: '/rateplan/v1/cancellation-policies/{id}',
			resource: 'cancellationpolicy',
			group: 'rateplan-v1',
	...
	company: [
		...
		},
		{
			...
			value: 'RateplanCompaniesByIdDelete',
			description:
	...
	noshowpolicy: [
		...
		{
			displayName: 'Delete a no-show policy',
			value: 'RateplanNo-show-policiesByIdDelete',
			description:
				"Use this call to delete a no-show policy.<br>You must have this scope: 'setup.manage'.",
			action: 'Delete a no-show policy',
			method: 'DELETE',
			path: '/rateplan/v1/no-show-policies/{id}',
			resource: 'noshowpolicy',
			group: 'rateplan-v1',
	...
	rate: [
		...
		{
			displayName: 'Deletes the rates for the rate plan',
			value: 'RateplanRate-plansByIdRatesDelete',
			description:
				"Deletes all rates in the specifed time range.<br>You must have at least one of these scopes: 'rates.delete, rates.manage'.",
			action: 'Deletes the rates for the rate plan',
			method: 'DELETE',
			path: '/rateplan/v1/rate-plans/{id}/rates',
			resource: 'rate',
			group: 'rateplan-v1',
		},
		{
			...
			value: 'RateplanRate-plansByIdRates$countGet',
			description:
				"To be able to count rates for a corporate rate plan a client must additionaly have\r\nthe 'rateplans.read-corporate' scope.<br>You must have at least one of these scopes: 'rates.read, rates.manage'.",
			action:
				'Returns the number of rates for a specific rate plan within the specifed time range.',
			method: 'GET',
	...
	rateplan: [
		...
		{
			displayName: 'Check if a rate plan exists',
			value: 'RateplanRate-plansByIdHead',
			description:
			...
			action: 'Check if a rate plan exists',
			method: 'HEAD',
	...
	service: [
		...
		},
		{
			...
			value: 'RateplanServicesByIdDelete',
			description:
	...
	customsubaccounts: [
		...
		{
			displayName: 'Delete a custom sub-account',
			value: 'SettingsSub-accountsByIdDelete',
			description:
			...
			action: 'Delete a custom sub-account',
			method: 'DELETE',
			path: '/settings/v1/sub-accounts/{id}',
			resource: 'customsubaccounts',
			group: 'settings-v1',
	...
	marketsegment: [
		...
		{
			displayName: 'Delete a market segment.',
			value: 'SettingsMarket-segmentsByIdDelete',
			description:
				"Use this call to delete a market segment.<br>You must have this scope: 'setup.manage'.",
			action: 'Delete a market segment.',
			method: 'DELETE',
			path: '/settings/v1/market-segments/{id}',
			resource: 'marketsegment',
			group: 'settings-v1',
	...
	timeslicedefinitions: [
		...
		{
			displayName: 'Delete a certain time slice definition',
			value: 'SettingsPropertiesByPropertyIdTime-slice-definitionsByIdDelete',
			description:
			...
			action: 'Delete a certain time slice definition',
			method: 'DELETE',
			path: '/settings/v1/properties/{propertyId}/time-slice-definitions/{id}',
			resource: 'timeslicedefinitions',
			group: 'settings-v1',
...
export const operationOptions: INodeProperties[] = [
	{
		...
		options: [
			{
				name: 'Returns the Current Account.',
				value: 'AccountAccountsCurrentGet',
				description:
			...
			{
				name: 'Replaces an Existing Account.',
				value: 'AccountAccountsCurrentPut',
				description:
			...
			},
			{
				...
				value: 'AccountAccountsGet',
				description: "Get the list of accounts.You must have this scope: 'accounts.read'",
				action: 'Returns all accounts',
			},
			{
				name: 'Creates an Account with an Admin User.',
				value: 'AccountAccountsPost',
				description:
					"Use this call to create a new account.You must have this scope: 'account.create'",
				action: 'Creates an account with an admin user',
			},
		],
		default: 'AccountAccountsCurrentGet',
	},
	{
		displayName: 'Operation',
		name: 'operation',
		...
		default: 'AccountAccount-actionsCurrentSuspendPut',
	},
	{
		displayName: 'Operation',
		name: 'operation',
		...
		options: [
			...
			},
			{
				...
				value: 'AvailabilityUnit-groupsByIdPatch',
				description:
					"You can replace AllowedOverbooking for a unit groupYou must have this scope: 'availability.manage'",
				action: 'Allows to modify the unit group availability',
			},
			{
	...
	},
	{
		...
		options: [
			{
				name: 'Check if a Block Exists',
				value: 'BookingBlocksByIdHead',
				description:
					"Check if a block exists by IDYou must have at least one of these scopes: 'blocks.read, reservations.read, reservations.manage'",
				action: 'Check if a block exists',
			},
			{
			...
			},
			{
				...
				value: 'BookingBlocksByIdDelete',
				description:
					"Use this call to delete a block. This is only possible as long as no reservation was picked up yet even if all of them are canceledYou must have at least one of these scopes: 'blocks.manage, reservations.manage'.",
				action: 'Delete a specific block',
			},
			{
			...
			},
			{
				...
				value: 'BookingBlocks$countGet',
				description:
					"Returns number of blocks matching the filter criteriaYou must have at least one of these scopes: 'blocks.read, reservations.read, reservations.manage'",
				action: 'Returns number of blocks',
			},
		],
		default: 'BookingBlocksByIdHead',
	},
	{
		displayName: 'Operation',
		name: 'operation',
		...
		options: [
			{
				...
				value: 'BookingBookingsByIdReservations$forcePost',
				description:
					"Creates new reservations and adds them to an existing booking taking a list of reservations as inputYou must have at least one of these scopes: 'reservations.force-create, reservations.force-manage'",
				action:
					'Add one or multiple reservations to an existing booking regardless of availability or restrictions',
			},
			{
				...
				value: 'BookingBookingsByIdReservationsPost',
				description:
					"Creates new reservations and adds them to an existing booking taking a list of reservations as inputYou must have at least one of these scopes: 'reservations.create, reservations.manage'",
				action: 'Add one or multiple reservations to an existing booking',
			},
			{
		...
		options: [
			{
				...
				value: 'BookingGroupsByIdReservationsPost',
				description:
					"Creates new reservations and adds them to an existing group booking taking a list of reservations as inputYou must have at least one of these scopes: 'groups.manage, reservations.manage'",
				action:
					'Add one or multiple reservations to an existing group booking using blocked inventory',
			},
			{
				...
				value: 'BookingGroupsByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Add and replace Name - Add, replace and remove Comment - Add, replace and remove BookerComment - Add, replace and remove PaymentAccount - Add, replace and remove PropertyIds - Replace BookerYou must have at least one of these scopes: 'groups.manage, reservations.manage'",
				action: 'Allows to modify certain group booking properties',
			},
			{
				name: 'Check if a Certain Group Booking Exists',
				value: 'BookingGroupsByIdHead',
				description:
					"Check if a group booking exists by IDYou must have at least one of these scopes: 'groups.read, reservations.read, reservations.manage'",
				action: 'Check if a certain group booking exists',
			},
			{
			...
			},
			{
				...
				value: 'BookingGroupsByIdDelete',
				description:
					"Use this call to delete a group booking. This is only possible as long as no blocks exist that are linked to this group bookingYou must have at least one of these scopes: 'groups.manage, reservations.manage'.",
				action: 'Delete a certain group booking',
			},
			{
				...
				value: 'BookingGroupsGet',
				description:
					"Returns a list of all group bookings, filtered by the specified parameters. If no parameters are set, returns the entire listYou must have at least one of these scopes: 'groups.read, reservations.read, reservations.manage'.",
				action: 'Returns a list of all group bookings filtered by the specified parameters',
			},
			{
				...
				value: 'BookingGroupsByIdGet',
				description:
					"Retrieves a specific group booking with all its related blocksYou must have at least one of these scopes: 'groups.read, reservations.read, reservations.manage'",
				action: 'Returns a specific group booking',
			},
			{
				...
				value: 'BookingGroups$countGet',
				description:
					"Returns number of group bookings matching the filter criteriaYou must have at least one of these scopes: 'groups.read, reservations.read, reservations.manage'",
				action: 'Returns number of group bookings',
			},
		],
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'BookingReservations$countGet',
				description:
					"If no parameters are set, returns the total count of reservations.You must have at least one of these scopes: 'reservations.read, reservations.manage'",
				action:
					'Returns the number of reservations fulfilling the criteria specified in the parameters',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'BookingReservation-actionsByIdLock-unitPut',
				description:
					"Lock unit assignment for a reservation and prevent modification. It will fail for reservations not in status 'Confirmed' or 'InHouse'. It will also fail if Units have not been assigned to this reservation.You must have this scope: 'reservations.manage'",
				action: 'Lock unit assignment for a reservation',
			},
			{
			...
			},
			{
				...
				value: 'BookingReservation-actionsByIdUnlock-unitPut',
				description:
					"Unlock unit assignment for a reservation and allow modification. It will fail if the reservation is not locked.You must have this scope: 'reservations.manage'.",
				action: 'Unlock unit assignment for a reservation',
			},
		],
	...
	},
	{
		...
		displayOptions: {
			show: {
				resource: ['types'],
				group: ['booking-v1', 'finance-v1', 'inventory-v1'],
			},
		},
		options: [
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'FinanceFoliosByIdHead',
				description:
					"Check if the folio exists.You must have at least one of these scopes: 'folios.read, folios.manage'",
				action: 'Check if the folio exists',
			},
			{
			...
			},
			{
				...
				value: 'FinanceFolios$countGet',
				description:
					"Returns number of folios matching the filter criteria.You must have at least one of these scopes: 'folios.read, folios.manage'",
				action: 'Returns number of folios',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'FinanceFolio-actionsByFolioIdCorrectPost',
				description:
					"Allowance value posted must not exceed sum of charges minus existing allowancesYou must have this scope: 'folios.manage'",
				action:
			...
			},
			{
				...
				value: 'FinanceFolio-actionsByFolioIdMove-paymentsPut',
				description:
					"Move payments from one guest/booking folio to another - moving between different bookings is not supported, and will lead to an error. If one of the folios is closed, this action cannot be performed. The PSP reference, if present, will be removed when moving and only be persisted on the original payment.You must have at least one of these scopes: 'charges.move, folios.manage'",
				action: 'Move multiple payments from one guest booking folio to another',
			},
			{
			...
			},
			{
				...
				value: 'FinanceFolio-actionsByFolioIdBulk-allowancesPost',
				description:
					"Allowance value posted must not exceed sum of charges minus existing allowancesYou must have at least one of these scopes: 'allowances.post, folios.manage'",
				action: 'Posts allowances for a folio',
			},
			{
				...
				value: 'FinanceFolio-actionsByFolioIdChargesByChargeIdAllowancesPost',
				description:
					"Allowance value posted must not exceed source charge minus allowances posted for this chargeYou must have at least one of these scopes: 'allowances.post, folios.manage'",
				action: 'Posts an allowance for a charge',
			},
			{
		...
		options: [
			{
				...
				value: 'FinanceFoliosByFolioIdPaymentsByPaymentIdCancelPut',
				description:
					"Sets a pending payment with payment link to cancelled and triggers the cancellation.You must have this scope: 'folios.manage'",
				action: 'Cancels a pending payment link',
			},
			{
			...
			},
			{
				...
				value: 'FinanceFoliosByFolioIdPaymentsGet',
				description:
					"Returns a list of all payments for this folio ordered by creation date, newest firstYou must have at least one of these scopes: 'folios.read, folios.manage'",
				action: 'Get a list of payments',
			},
			{
				...
				value: 'FinanceFoliosByFolioIdRefundsGet',
				description:
					"Returns a list of all refunds for this folio ordered by creation date, newest firstYou must have at least one of these scopes: 'folios.read, folios.manage'",
				action: 'Get a list of refunds',
			},
			{
				...
				value: 'FinanceFoliosByFolioIdPaymentsByPaymentIdGet',
				description:
					"Get a payment by its IDYou must have at least one of these scopes: 'folios.read, folios.manage'",
				action: 'Get a payment by ID.',
			},
			{
				...
				value: 'FinanceFoliosByFolioIdRefundsByRefundIdGet',
				description:
					"Get a refund by its IDYou must have at least one of these scopes: 'folios.read, folios.manage'",
				action: 'Get a refund by ID.',
			},
			{
			...
			},
			{
				...
				value: 'FinanceFoliosByFolioIdPaymentsBy-terminalPost',
				description:
					"Trigger a terminal payment for the folio. The payment will be processed asynchronously. Use the location header to poll for the status of the payment. As long as a payment is pending it reduces the amount of allowed payments for the folio. The payment times out after 60 minutes automaticallyYou must have this scope: 'folios.manage'",
				action: 'Trigger a payment on a card terminal for the folio',
			},
			{
				...
				value: 'FinanceFoliosByFolioIdPaymentsBy-payment-accountPost',
				description:
					"Trigger a payment for the folio using the payment account stored on the reservation. The payment will be processed asynchronously. Use the location header to poll for the status of the payment. As long as a payment is pending it reduces the amount of allowed payments for the folio. The payment times out after 60 minutes automaticallyYou must have this scope: 'folios.manage'",
				action: 'Trigger a payment using the payment account stored on the reservation',
			},
			{
				...
				value: 'FinanceFoliosByFolioIdPaymentsByPaymentIdRefundsPost',
				description:
					"Trigger a refund for a specific payment on this folio. The refund will be processed asynchronously. Use the location header to poll for the status of the refund. As long as a refund is pending the allowed refund amount for this payment will be reduced by the amount. The refund times out after 10 minutes automaticallyYou must have this scope: 'folios.manage'",
				action: 'Trigger a refund for a specific payment',
			},
			{
				...
				value: 'FinanceFoliosByFolioIdRefundsPost',
				description:
					"Trigger a generic refund for the folio. The refund will be processed asynchronously. Use the location header to poll for the status of the refund. As long as a refund is pending it reduces the amount of allowed refunds for the folio. The refund times out after 60 minutes automaticallyYou must have this scope: 'folios.manage'",
				action: 'Trigger a refund for the folio',
			},
		],
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'FinanceAccountsAggregate-pairs-dailyPost',
				description:
					"Returns total amount credited from one account to anotherYou must have at least one of these scopes: 'subledger.read, accounting.read'",
				action:
					'Aggregates transactions pairs by date business day for all accounts and a given period',
			},
			{
	...
	},
	{
		...
		options: [
			{
				name: 'IntegrationUi-integrationsByTargetByIdDelete',
				value: 'IntegrationUi-integrationsByTargetByIdDelete',
				description: "You must have this scope: 'integration:ui-integrations.manage'",
				action: 'Integration ui integrations by target by id delete',
			},
			{
				name: 'IntegrationUi-integrationsByTargetByIdGet',
				value: 'IntegrationUi-integrationsByTargetByIdGet',
				description: "You must have this scope: 'integration:ui-integrations.manage'",
				action: 'Integration ui integrations by target by id get',
			},
			{
				name: 'IntegrationUi-integrationsByTargetByIdPut',
				value: 'IntegrationUi-integrationsByTargetByIdPut',
				description: "You must have this scope: 'integration:ui-integrations.manage'",
				action: 'Integration ui integrations by target by id put',
			},
			{
				name: 'IntegrationUi-integrationsByTargetGet',
				value: 'IntegrationUi-integrationsByTargetGet',
				description: "You must have this scope: 'integration:ui-integrations.manage'",
				action: 'Integration ui integrations by target get',
			},
			{
				name: 'IntegrationUi-integrationsByTargetPost',
				value: 'IntegrationUi-integrationsByTargetPost',
				description: "You must have this scope: 'integration:ui-integrations.manage'",
				action: 'Integration ui integrations by target post',
			},
			{
				name: 'IntegrationUi-integrationsGet',
				value: 'IntegrationUi-integrationsGet',
				description: "You must have this scope: 'integration:ui-integrations.manage'",
				action: 'Integration ui integrations get',
			},
			{
				name: 'Tests a Private Source Integration.',
				value: 'IntegrationUi-integrationsByTargetById$testGet',
				description:
		...
		default: 'IntegrationUi-integrationsByTargetByIdDelete',
	},
	{
		displayName: 'Operation',
		name: 'operation',
		...
		options: [
			...
			{
				name: 'Check if a Property Exists',
				value: 'InventoryPropertiesByIdHead',
				description:
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'InventoryProperty-actionsByIdResetPut',
				description:
					"Use this endpoint to delete all transactional data related to some test property This operation deletes all transactional data related to the specified property. The property must be in 'Test' status.You must have at least one of these scopes: 'properties.manage, setup.manage'.",
				action: 'Reset a test property and delete all transactional data',
			},
		],
		default: 'InventoryProperty-actionsByIdClonePost',
	},
	{
		displayName: 'Operation',
		name: 'operation',
		...
		options: [
			{
				...
				value: 'InventoryUnitsPatch',
				description:
					"Here's a list of allowed operations: - Set unit condition - Set unit description - Set unit name - Set unit unitGroupId - Set unit maxPersons - Add unit attribute - Remove unit attributeYou must have at least one of these scopes: 'units.manage, setup.manage'",
				action: 'Allows to patch one or more units',
			},
			{
		...
		options: [
			{
				...
				value: 'InventoryUnit-attributesByIdPatch',
				description:
					"Here's a list of allowed operations: - Replace / Remove DescriptionYou must have at least one of these scopes: 'unitattributes.manage, setup.manage'",
				action: 'Allows to modify unit attribute',
			},
			{
		...
		options: [
			{
				...
				value: 'OperationsMaintenancesByIdHead',
				description:
					"Check if a maintenance exists by ID.You must have at least one of these scopes: 'maintenances.read, maintenances.manage'",
				action: 'Check if a maintenance exists',
			},
			{
			...
			},
			{
				...
				value: 'OperationsMaintenances$countGet',
				description:
					"Returns the number of maintenances matching your filter.You must have at least one of these scopes: 'maintenances.read, maintenances.manage'",
				action: 'Returns number of maintenances',
			},
		],
		...
		options: [
			{
				...
				value: 'RateplanCancellation-policiesByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace name and description - Replace the period from reference - Replace the reference - Replace the fee details: fixed and percent valuesYou must have at least one of these scopes: 'settings.manage, setup.manage'",
				action: 'Allows to modify properties of a cancellation policy',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'RateplanCompaniesByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace name, invoicingEmail, phone, taxId, additionalTaxId, additionalTaxId2, address, canCheckOutOnAr - Add, replace and remove rate plansYou must have this scope: 'companies.manage'",
				action: 'Modify a company',
			},
		],
		...
		options: [
			{
				...
				value: 'RateplanNo-show-policiesByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace name and description - Replace the fee details: fixed and percent valuesYou must have at least one of these scopes: 'settings.manage, setup.manage'",
				action: 'Allows to modify properties of a no show policy',
			},
			{
		...
		options: [
			{
				...
				value: 'RateplanRatesPatch',
				description:
					"Note that the specified PATCH operations are applied to each and every rate for the specified time range. Here is the list of operations that are currently allowed: - Add, replace and remove Price - Add, replace and remove RestrictionsYou must have this scope: 'rates.manage'.",
				action: 'Allows to patch the rates of multiple rate plans',
			},
			{
			...
			},
			{
				...
				value: 'RateplanRate-plansByIdRates$countGet',
				description:
					"To be able to count rates for a corporate rate plan a client must additionaly have the 'rateplans.read-corporate' scope.You must have at least one of these scopes: 'rates.read, rates.manage'",
				action:
					'Returns the number of rates for a specific rate plan within the specifed time range',
			},
		],
	...
	},
	{
		...
		options: [
			...
			{
				name: 'Check if a Rate Plan Exists',
				value: 'RateplanRate-plansByIdHead',
				description:
					"Check if a rate plan exists by ID. To be able to check if a corporate rate plan exists a client must additionaly have 'rateplans.read-corporate' scope assigned.You must have at least one of these scopes: 'rateplans.read, setup.read, setup.manage'.",
				action: 'Check if a rate plan exists',
			},
			{
		...
		options: [
			{
				...
				value: 'RateplanServicesByIdHead',
				description:
					"Check if a service exists by ID.You must have at least one of these scopes: 'services.read, setup.read, setup.manage'",
				action: 'Check if a service exists',
			},
			{
			...
			},
			{
				...
				value: 'RateplanServicesByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace Name - Replace Description - Replace DefaultGrossPrice - Replace PricingUnit - Replace PostNextDay - Replace Availability - Add/Replace/Remove/Update AccountingConfigs - Replace ChannelCodes - Replace AgeCategoryIdYou must have at least one of these scopes: 'services.manage, setup.manage'",
				action: 'Modify a service',
			},
			{
				...
				value: 'RateplanServices$countGet',
				description:
					"Returns number of servicesYou must have at least one of these scopes: 'services.read, setup.read, setup.manage'",
				action: 'Returns number of services',
			},
		],
		default: 'RateplanServicesByIdHead',
	},
	{
		displayName: 'Operation',
		name: 'operation',
		...
		options: [
			{
				...
				value: 'SettingsCity-taxByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace name and description - Replace value and type - Replace or delete the VAT type - Replace priorityYou must have at least one of these scopes: 'settings.manage, setup.manage'",
				action: 'Allows to modify city tax',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'SettingsSub-accountsByIdHead',
				description:
					"Check if the sub-account exists.You must have at least one of these scopes: 'subledger.read, setup.read, setup.manage'",
				action: 'Check if the sub account exists',
			},
			{
			...
			{
				name: 'Delete a Custom Sub-Account',
				value: 'SettingsSub-accountsByIdDelete',
				description:
			...
			},
			{
				...
				value: 'SettingsSub-accounts$countGet',
				description:
					"Returns number of sub-account.You must have at least one of these scopes: 'subledger.read, setup.read, setup.manage'",
				action: 'Returns number of sub accounts',
			},
			{
		...
		options: [
			{
				...
				value: 'SettingsFeaturesByPropertyIdGet',
				description:
					"Get feature settings for a property.You must have at least one of these scopes: 'settings.read, setup.read, setup.manage'",
				action: 'Get feature settings for a property',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				value: 'SettingsInvoice-addressPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace AddressLine1 - Add, replace or delete AddressLine2 - Replace PostalCode - Replace City - Replace CountryCodeYou must have at least one of these scopes: 'setup.manage, settings.manage'",
				action: 'Change fields in the invoice address of one or more properties',
			},
		],
		...
		options: [
			{
				...
				value: 'SettingsLanguagesGet',
				description:
					"Get the language settingsYou must have at least one of these scopes: 'settings.read, setup.read, setup.manage'",
				action: 'Get the language settings for the account',
			},
			{
		...
		options: [
			{
				...
				value: 'SettingsMarket-segmentsByIdPatch',
				description:
					"Here is the list of operations that are currently allowed: - Replace name - Add, replace and remove description - Add, replace and remove propertyIdsYou must have at least one of these scopes: 'settings.manage, setup.manage'",
				action: 'Allows to modify market segment',
			},
			{
				...
				value: 'SettingsMarket-segmentsByIdHead',
				description:
					"Check if a market segment exists by ID.You must have at least one of these scopes: 'setup.read, setup.manage'",
				action: 'Check if a market segment exists',
			},
			{
			...
			{
				name: 'Delete a Market Segment.',
				value: 'SettingsMarket-segmentsByIdDelete',
				description:
					"Use this call to delete a market segment.You must have this scope: 'setup.manage'",
				action: 'Delete a market segment',
			},
			{
				...
				value: 'SettingsMarket-segmentsByIdGet',
				description:
					"Get a market segment by ID.You must have at least one of these scopes: 'setup.read, setup.manage'",
				action: 'Get a market segment',
			},
			{
			...
			},
			{
				...
				value: 'SettingsMarket-segments$countGet',
				description:
					"Returns number of market segments.You must have at least one of these scopes: 'setup.read, setup.manage'",
				action: 'Returns number of market segments',
			},
		],
	...
	},
	{
		...
		options: [
			...
			{
				name: 'Delete a Certain Time Slice Definition',
				value: 'SettingsPropertiesByPropertyIdTime-slice-definitionsByIdDelete',
				description:
					"Use this call to delete a time slice definition. This is only possible if a time slice definition is not in-useYou must have at least one of these scopes: 'settings.manage, setup.manage'.",
				action: 'Delete a certain time slice definition',
			},
			{
