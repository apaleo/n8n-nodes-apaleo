...
export const parameterFields: INodeProperties[] = [
  ...
  "location": {
		...
		options: [
			{
				...
				default: false,
				description:
					'Whether should units that are set OutOfService in the defined time period be returned as available',
			},
			{
			...
			},
			{
				...
				options: [
					...
					{ name: 'CleanToBeInspected', value: 'CleanToBeInspected' },
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['AvailabilityUnit-groupsGet'], resource: ['availability'] },
		},
		default: '',
		description: 'The property ID',
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					"Whether when set to 'true', only the unit groups sold by the specified time slice template and time slice definition IDs are returned, otherwise all unit groups are returned",
			},
			{
				displayName: 'pageNumber',
				name: 'pageNumber',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['AvailabilityUnit-groupsByIdPatch'], resource: ['availability'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['AvailabilityServicesGet'], resource: ['availability'] },
		},
		default: '',
		description: 'The property ID',
	},
  ...
  "timeSlices": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBlock-actionsByIdConfirmPut'], resource: ['blockactions'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBlock-actionsByIdReleasePut'], resource: ['blockactions'] },
		},
		default: '',
		description: 'ID of the block that should be processed',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBlock-actionsByIdCancelPut'], resource: ['blockactions'] },
		},
		default: '',
		description: 'ID of the block that should be processed',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBlock-actionsByIdWashPut'], resource: ['blockactions'] },
		},
		default: '',
		description: 'ID of the block that should be processed',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBlock-actionsByIdAmendPut'], resource: ['blockactions'] },
		},
		default: '',
  ...
  "transactionReference": "564578124534890J"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBookingsByIdReservationsPost'], resource: ['booking'] },
		},
		default: '',
  ...
  "transactionReference": "RFEUFHEW"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingBookingsByIdReservations$forcePost'], resource: ['booking'] },
		},
		default: '',
		description: 'ID of the booking the reservations should be attached to',
	},
...
`,
	...
	},
	{
		...
		type: 'collection',
		displayOptions: { show: { operation: ['BookingGroups$countGet'], resource: ['group'] } },
		default: {},
		options: [
			{
				displayName: 'textSearch',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingGroupsByIdReservationsPost'], resource: ['group'] },
		},
		default: '',
  ...
  "reservations": [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether return also offers that are currently not publicly bookable as restrictions are violated. By default only available offers are returned.',
			},
			{
		...
		options: [
			{
				...
				default: false,
				description:
					"Whether if set to `true`, returns only reservations, in which all folios are closed and have an invoice. If set to `false`, returns only reservations, in which some of the folios are open or don't have an invoice.",
			},
			{
			...
			},
			{
				...
				options: [
					...
					{ name: 'ArrivalAndCheckIn', value: 'ArrivalAndCheckIn' },
					{ name: 'Cancellation', value: 'Cancellation' },
					{ name: 'Creation', value: 'Creation' },
					{ name: 'Departure', value: 'Departure' },
					{ name: 'DepartureAndCheckOut', value: 'DepartureAndCheckOut' },
			...
			},
			{
				...
				options: [
					...
					{ name: 'balance:asc', value: 'balance:asc' },
					{ name: 'balance:desc', value: 'balance:desc' },
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['BookingReservations$countGet'], resource: ['reservation'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingReservationsByIdGet'], resource: ['reservation'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingReservationsByIdPatch'], resource: ['reservation'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingReservationsByIdOffersGet'], resource: ['reservation'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingReservationsByIdService-offersGet'], resource: ['reservation'] },
		},
		default: '',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether depending on the postNextDay setting of a service it will by default be posted before or after midnight. Breakfast is usually delivered on the next morning, so all the dates from the day after arrival to the departure day are default dates and will have this flag set to true. For services like a dinner it is the other way around. With this query parameter, you can also ask for the dates, that usually the service will not be booked. It defaults to true',
			},
			{
				displayName: 'includeUnavailable',
				name: 'includeUnavailable',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingReservationsByIdServicesGet'], resource: ['reservation'] },
		},
		default: '',
		description: 'ID of the reservation',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingReservationsByIdServicesDelete'], resource: ['reservation'] },
		},
		default: '',
		description: 'ID of the reservation',
	},
		...
		options: [
			{
				...
				default: false,
				description:
					'Whether define if city tax should be added for this reservation or not. The default is "true".',
			},
		],
	},
	{
	...
	},
	{
		...
		default: `{
  "arrival": "2025-07-08T17:00:00+02:00",
  "departure": "2025-07-10T11:00:00+02:00",
  "adults": 1,
  "childrenAges": [
    6
  ],
  ...
  "dates": [
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['BookingReservation-actionsByIdLock-unitPut'],
				resource: ['reservationactions'],
			},
		},
		default: '',
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['BookingReservation-actionsByIdUnlock-unitPut'],
				resource: ['reservationactions'],
			},
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['BookingTypesByTypeAllowed-valuesGet'], resource: ['types'] },
		},
		default: 'Gender',
		description: 'The type to provide allowed values for',
		options: [
			{ name: 'Gender', value: 'Gender' },
			{ name: 'IdentificationType', value: 'IdentificationType' },
		],
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				options: [
					{ name: 'value:asc', value: 'value:asc' },
					{ name: 'value:desc', value: 'value:desc' },
				],
			},
		],
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether if set to \`true\`, only return folios that have been checked out on accounts receivables Otherwise, returns all',
			},
			{
				displayName: 'companyIds',
				name: 'companyIds',
			...
			},
			{
				...
				default: false,
				description:
					'Whether if set to \`true\`, closed folios are filtered out from the result collection - <b>DEPRECATED: This field will be removed soon. Please use Status=Open instead.</b>.',
			},
			{
				displayName: 'Expand',
				name: 'expand',
				...
				options: [
					...
					{ name: 'allowedActions', value: 'allowedActions' },
					{ name: 'Charges', value: 'charges' },
					{ name: 'Company', value: 'company' },
					{ name: 'Payments', value: 'payments' },
					{ name: 'transitoryCharges', value: 'transitoryCharges' },
...
Specifying this parameter will ignore the <b>Type</b> parameter and treat as if it would be set to "External" instead`,
			...
			},
			{
				...
				default: false,
				description:
					'Whether if set to `true`, only return empty folios (no unmoved [transitory] charges, no unmoved payments, no allowances). If set to `false`, only return non-empty folios.',
			},
			{
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFolio-actionsByFolioIdChargesPost'], resource: ['folioactions'] },
		},
		default: '',
		description: 'The folio ID',
	},
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFolio-actionsByFolioIdClosePut'], resource: ['folioactions'] },
		},
		default: '',
		description: 'The folio ID',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFolio-actionsByFolioIdReopenPut'], resource: ['folioactions'] },
		},
		default: '',
		description: 'The folio ID',
	},
  ...
  "transitoryChargeIds": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFolio-actionsBulk-movePut'], resource: ['folioactions'] },
		},
		default: `{
  "items": [
    {
  ...
  "paymentIds": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFolio-actionsByFolioIdCorrectPost'], resource: ['folioactions'] },
		},
		default: '',
		description: 'The folio ID',
	},
  ...
  "type": "ByPercent"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFoliosByFolioIdPaymentsGet'], resource: ['foliopayments'] },
		},
		default: '',
	},
	{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFoliosByFolioIdPaymentsPost'], resource: ['foliopayments'] },
		},
		default: '',
	},
	{
  ...
  "paidCharges": [
	...
	},
	{
		...
		default: `{
  "expiresAt": "2025-07-08T13:01:28.7580976Z",
  "countryCode": "de",
  ...
  "paidCharges": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFoliosByFolioIdRefundsGet'], resource: ['foliopayments'] },
		},
		default: '',
	},
	{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceFoliosByFolioIdRefundsPost'], resource: ['foliopayments'] },
		},
		default: '',
	},
	{
  ...
  "reason": "Refund for the cancelled service"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceInvoicesPreview-pdfGet'], resource: ['invoice'] },
		},
		default: '',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether if set to \`true\`, only return invoices with an open balance (AR) Otherwise, returns all',
			},
			{
				displayName: 'companyIds',
				name: 'companyIds',
...
If not set, returns all invoices. - <b>DEPRECATED: This field will be removed at 25.06.2022. Use filtering by \`Status\` instead</b>`,
			...
			},
			{
				...
				options: [
					{ name: 'FullyPaid', value: 'FullyPaid' },
					{ name: 'Unpaid', value: 'Unpaid' },
					{ name: 'WrittenOff', value: 'WrittenOff' },
				],
			},
		],
	},
  ...
  "languageCode": "en"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceInvoice-actionsByIdPayPut'], resource: ['invoiceaction'] },
		},
		default: '',
		description: 'The invoice ID',
	},
  ...
  "receipt": "BANK-123456"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceInvoice-actionsByIdCancelPut'], resource: ['invoiceaction'] },
		},
		default: '',
		description: 'The invoice ID',
	},
  ...
  "reasonCode": "ChangeOfRecipientDetails"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsAggregate-pairs-dailyPost'], resource: ['subledger'] },
		},
		default: '',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				options: [
					{ name: 'AccountsReceivable', value: 'AccountsReceivable' },
					{ name: 'CityTaxes', value: 'CityTaxes' },
					{ name: 'House', value: 'House' },
					{ name: 'Liabilities', value: 'Liabilities' },
					{ name: 'LossOfAccountsReceivable', value: 'LossOfAccountsReceivable' },
					{ name: 'Payments', value: 'Payments' },
					{ name: 'Receivables', value: 'Receivables' },
					{ name: 'Revenues', value: 'Revenues' },
					{ name: 'SecondCityTax', value: 'SecondCityTax' },
					{ name: 'TransitoryItems', value: 'TransitoryItems' },
					{ name: 'Vat', value: 'Vat' },
					{ name: 'VatOnLiabilities', value: 'VatOnLiabilities' },
				],
			},
			{
				displayName: 'Idempotency-Key',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsAggregate-dailyPost'], resource: ['subledger'] },
		},
		default: '',
		description: 'Specifies the property transactions will be aggregated for',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsAggregatePost'], resource: ['subledger'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsExport-dailyPost'], resource: ['subledger'] },
		},
		default: '',
		description: 'Specifies the property transactions will be aggregated for',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsExport-gross-dailyPost'], resource: ['subledger'] },
		},
		default: '',
		description: 'Specifies the property transactions will be aggregated for',
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether if set to true, also includes archived accounts. If not set, or set to false, it only returns non-archived accounts.',
			},
			{
				displayName: 'accountingSchema',
				name: 'accountingSchema',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceExternal-accountsGet'], resource: ['subledger'] },
		},
		default: '',
		description: 'Filter account list by property ID',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsByNumberGet'], resource: ['subledger'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['FinanceAccountsChild-accountsGet'], resource: ['subledger'] },
		},
		default: '',
		description: 'Filter account list by property ID',
	},
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['IntegrationUi-integrationsByTargetByIdGet'],
				resource: ['uiintegrations'],
			},
		},
		default: 'DashboardPropertyContext',
		options: [
			{ name: 'AccountMenuApps', value: 'AccountMenuApps' },
			{ name: 'BookingDetailsTab', value: 'BookingDetailsTab' },
			{ name: 'CompanyDetailsTab', value: 'CompanyDetailsTab' },
			{ name: 'DashboardAccountContext', value: 'DashboardAccountContext' },
			{ name: 'DashboardPropertyContext', value: 'DashboardPropertyContext' },
			{ name: 'GuestDetailsDialog', value: 'GuestDetailsDialog' },
			{ name: 'PropertyMenuApps', value: 'PropertyMenuApps' },
			{ name: 'PropertyMenuReports', value: 'PropertyMenuReports' },
			{ name: 'ReservationDetailsTab', value: 'ReservationDetailsTab' },
		],
	},
	{
		displayName: 'ID',
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['IntegrationUi-integrationsByTargetByIdPut'],
				resource: ['uiintegrations'],
			},
		},
		default: 'DashboardPropertyContext',
  ...
  "roles": [
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['IntegrationUi-integrationsByTargetByIdDelete'],
				resource: ['uiintegrations'],
			},
		},
		default: 'DashboardPropertyContext',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['IntegrationUi-integrationsByTargetGet'], resource: ['uiintegrations'] },
		},
		default: 'DashboardPropertyContext',
		options: [
			{ name: 'AccountMenuApps', value: 'AccountMenuApps' },
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['IntegrationUi-integrationsByTargetPost'], resource: ['uiintegrations'] },
		},
		default: 'DashboardPropertyContext',
		options: [
			{ name: 'AccountMenuApps', value: 'AccountMenuApps' },
  ...
  "roles": [
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['IntegrationUi-integrationsByTargetById$testGet'],
				resource: ['uiintegrations'],
			},
		},
		default: 'DashboardPropertyContext',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether include archived properties in the result. If not set, or set to false, it only returns non-archived properties.',
			},
			{
				displayName: 'pageNumber',
				name: 'pageNumber',
  ...
  "currencyCode": "EUR"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryPropertiesByIdHead'], resource: ['property'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryPropertiesByIdPatch'], resource: ['property'] },
		},
		default: '',
		description: 'The ID of the property',
	},
...
`,
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['InventoryProperty-actionsByIdClonePost'],
  ...
  "currencyCode": "EUR"
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['InventoryProperty-actionsByIdArchivePut'],
				resource: ['propertyactions'],
			},
		},
		default: '',
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['InventoryProperty-actionsByIdSet-livePut'],
				resource: ['propertyactions'],
			},
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryProperty-actionsByIdResetPut'], resource: ['propertyactions'] },
		},
		default: '',
		description: 'The ID of the property',
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				options: [
					{ name: 'connectedUnits', value: 'connectedUnits' },
					{ name: 'Property', value: 'property' },
					{ name: 'unitGroup', value: 'unitGroup' },
				],
			},
...
`,
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				options: [
					{ name: 'OutOfInventory', value: 'OutOfInventory' },
					{ name: 'OutOfOrder', value: 'OutOfOrder' },
  ...
  "units": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-attributesByIdGet'], resource: ['unitattribute'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-attributesByIdPatch'], resource: ['unitattribute'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-attributesByIdDelete'], resource: ['unitattribute'] },
		},
		default: '',
		description: 'ID of unit attribute',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-attributesByIdHead'], resource: ['unitattribute'] },
		},
		default: '',
		description: 'The ID of the unit attribute',
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['InventoryUnit-attributesGet'], resource: ['unitattribute'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-attributesPost'], resource: ['unitattribute'] },
		},
		default: `{
  "name": "Floor 1",
  ...
  "type": "BedRoom"
		...
		options: [
			{
				...
				options: [
					{ name: 'connectedUnitGroups', value: 'connectedUnitGroups' },
					{ name: 'Property', value: 'property' },
				],
			},
			{
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['InventoryUnit-groups$countGet'], resource: ['unitgroup'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-groupsByIdHead'], resource: ['unitgroup'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-groupsByIdGet'], resource: ['unitgroup'] },
		},
		default: '',
		description: 'The ID of the unit group',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-groupsByIdPut'], resource: ['unitgroup'] },
		},
		default: '',
		description: 'The ID of the unit group',
	},
  ...
  "rank": 2
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['InventoryUnit-groupsByIdDelete'], resource: ['unitgroup'] },
		},
		default: '',
		description: 'The ID of the unit group',
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['LogsBookingReservationGet'], resource: ['bookinglogs'] },
		},
		default: {},
		options: [
			{
			...
			},
			{
				...
				options: [
					...
					{ name: 'CheckedOut', value: 'CheckedOut' },
					{ name: 'CheckInReverted', value: 'CheckInReverted' },
					{ name: 'CityTaxAdded', value: 'CityTaxAdded' },
					{ name: 'CityTaxRemoved', value: 'CityTaxRemoved' },
					{ name: 'Created', value: 'Created' },
					{ name: 'InvoiceStatusChanged', value: 'InvoiceStatusChanged' },
					{ name: 'PaymentAccountRemoved', value: 'PaymentAccountRemoved' },
					{ name: 'PaymentAccountSet', value: 'PaymentAccountSet' },
					{ name: 'PickedUpFromBlock', value: 'PickedUpFromBlock' },
					{ name: 'SetToNoShow', value: 'SetToNoShow' },
					{ name: 'UnitAssigned', value: 'UnitAssigned' },
					{ name: 'UnitLocked', value: 'UnitLocked' },
					{ name: 'UnitUnassigned', value: 'UnitUnassigned' },
					{ name: 'UnitUnlocked', value: 'UnitUnlocked' },
				],
			},
			{
				displayName: 'Expand',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Filter the log entries by event types',
				options: [
					{ name: 'AllowanceMovedFromFolio', value: 'AllowanceMovedFromFolio' },
					{ name: 'AllowanceMovedToFolio', value: 'AllowanceMovedToFolio' },
					{ name: 'AllowancePosted', value: 'AllowancePosted' },
					{ name: 'ChargeMovedFromFolio', value: 'ChargeMovedFromFolio' },
					{ name: 'ChargeMovedToFolio', value: 'ChargeMovedToFolio' },
					{ name: 'ChargePosted', value: 'ChargePosted' },
					{ name: 'ChargesChanged', value: 'ChargesChanged' },
					{ name: 'Closed', value: 'Closed' },
					{ name: 'Created', value: 'Created' },
					{ name: 'DebitorChanged', value: 'DebitorChanged' },
					{ name: 'Deleted', value: 'Deleted' },
					{ name: 'DepositItemAdded', value: 'DepositItemAdded' },
					{ name: 'DepositItemChanged', value: 'DepositItemChanged' },
					{ name: 'DepositItemDeleted', value: 'DepositItemDeleted' },
					{ name: 'InvoiceCanceled', value: 'InvoiceCanceled' },
					{ name: 'InvoiceCreated', value: 'InvoiceCreated' },
					{ name: 'InvoicePaid', value: 'InvoicePaid' },
					{ name: 'InvoiceWrittenOff', value: 'InvoiceWrittenOff' },
					{ name: 'PaymentAdded', value: 'PaymentAdded' },
					{ name: 'PaymentCanceled', value: 'PaymentCanceled' },
					{ name: 'PaymentFailed', value: 'PaymentFailed' },
					{ name: 'PaymentMovedFromFolio', value: 'PaymentMovedFromFolio' },
					{ name: 'PaymentMovedToFolio', value: 'PaymentMovedToFolio' },
					{ name: 'PaymentPosted', value: 'PaymentPosted' },
					{ name: 'RefundAdded', value: 'RefundAdded' },
					{ name: 'RefundFailed', value: 'RefundFailed' },
					{ name: 'RefundMovedFromFolio', value: 'RefundMovedFromFolio' },
					{ name: 'RefundMovedToFolio', value: 'RefundMovedToFolio' },
					{ name: 'RefundPosted', value: 'RefundPosted' },
					{ name: 'Reopened', value: 'Reopened' },
					{ name: 'TransitoryChargeMovedFromFolio', value: 'TransitoryChargeMovedFromFolio' },
					{ name: 'TransitoryChargeMovedToFolio', value: 'TransitoryChargeMovedToFolio' },
					{ name: 'TransitoryChargePosted', value: 'TransitoryChargePosted' },
				],
			},
			{
				displayName: 'folioIds',
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['LogsFinanceNight-auditGet'], resource: ['financelogs'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['LogsFinanceTransactions-exportGet'], resource: ['financelogs'] },
		},
		default: {},
		options: [
			{
			...
			},
			{
				...
				options: [
					...
					{ name: 'AggregatePairs', value: 'AggregatePairs' },
					{ name: 'Raw', value: 'Raw' },
				],
			},
		],
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['OperationsMaintenancesGet'], resource: ['maintenance'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsMaintenancesPost'], resource: ['maintenance'] },
		},
		default: `{
  "unitId": "MUC-JQI",
  "from": "2025-07-06T10:52:45+02:00",
  "to": "2025-07-08T10:52:45+02:00",
  "type": "OutOfService",
  "description": "The remote control for the TV needs to be replaced."
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['OperationsMaintenances$countGet'], resource: ['maintenance'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsMaintenancesBulkPost'], resource: ['maintenance'] },
		},
		default: `{
  "maintenances": [
    {
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsMaintenancesByIdPatch'], resource: ['maintenance'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsMaintenancesByIdDelete'], resource: ['maintenance'] },
		},
		default: '',
		description: 'The ID of the maintenance',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsMaintenancesByIdGet'], resource: ['maintenance'] },
		},
		default: '',
		description: 'The ID of the maintenance',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsMaintenancesByIdHead'], resource: ['maintenance'] },
		},
		default: '',
		description: 'The ID of the maintenance',
	},
		...
		options: [
			{
				...
				default: false,
				description:
					'Whether flag if reservations in the state confirmed, which should have been checked in by now, should be marked as no show. The default value is true and we strongly advise against setting it to false, because different reports rely on setting reservations which were not checked in correctly to no show.',
			},
		],
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['OperationsUnits-conditionPut'], resource: ['operations'] },
		},
		default: `{
  "unitsConditions": [
    {
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsAge-categoriesByIdGet'], resource: ['agecategory'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsAge-categoriesByIdPatch'], resource: ['agecategory'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsAge-categoriesByIdDelete'], resource: ['agecategory'] },
		},
		default: '',
		description: 'The ID of the age category',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsAge-categoriesPost'], resource: ['agecategory'] },
		},
		default: `{
  "code": "BABY",
  "propertyId": "MUC",
  ...
  "maxAge": 2
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsAge-categoriesGet'], resource: ['agecategory'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanCancellation-policiesPost'], resource: ['cancellationpolicy'] },
		},
		default: `{
  "code": "FLE",
  "name": {
  ...
  "fee": {
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['RateplanCancellation-policiesGet'], resource: ['cancellationpolicy'] },
		},
		default: {},
		options: [
			{
...
`,
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['RateplanCancellation-policiesByIdDelete'],
				resource: ['cancellationpolicy'],
			},
		},
		default: '',
...
`,
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['RateplanCorporate-codesCodesGet'], resource: ['corporatecodes'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanNo-show-policiesPost'], resource: ['noshowpolicy'] },
		},
		default: `{
  "code": "NONREF",
  "name": {
  ...
  "fee": {
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['RateplanNo-show-policiesGet'], resource: ['noshowpolicy'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanNo-show-policiesByIdGet'], resource: ['noshowpolicy'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanNo-show-policiesByIdPatch'], resource: ['noshowpolicy'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanNo-show-policiesByIdDelete'], resource: ['noshowpolicy'] },
		},
		default: '',
		description: 'The ID of the no-show policy',
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['RateplanPromo-codesCodesGet'], resource: ['promocodes'] },
		},
		default: {},
		options: [
			{
  ...
  "rates": [
    {
      "from": "2025-07-06T17:00:00+02:00",
      "to": "2025-07-07T11:00:00+02:00",
      "price": {
        "amount": 123.50,
        "currency": "EUR"
      },
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanRate-plansByIdRatesDelete'], resource: ['rate'] },
		},
		default: '',
		description: 'The ID of the rate plan',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanRate-plansByIdRates$countGet'], resource: ['rate'] },
		},
		default: '',
		description: 'The ID of the rate plan',
	},
...
`,
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				options: [
					{ name: 'ageCategories', value: 'ageCategories' },
					{ name: 'bookingPeriods', value: 'bookingPeriods' },
					{ name: 'cancellationPolicy', value: 'cancellationPolicy' },
					{ name: 'Property', value: 'property' },
					{ name: 'Services', value: 'services' },
					{ name: 'Surcharges', value: 'surcharges' },
					{ name: 'unitGroup', value: 'unitGroup' },
				],
			},
			{
  ...
  "bookingPeriods": [
    {
      "from": "2025-06-29T10:52:45.2592247+02:00",
      "to": "2025-07-13T10:52:45.2592247+02:00"
    },
    {
      "from": "2025-07-16T10:52:45.2592247+02:00",
      "to": "2025-09-04T10:52:45.2592247+02:00"
    }
  ],
  "restrictions": {
    "minAdvance": {
...
`,
	...
	},
	{
		...
		type: 'fixedCollection',
		required: true,
		displayOptions: { show: { operation: ['RateplanRate-plansDelete'], resource: ['rateplan'] } },
		typeOptions: { multipleValues: true },
		default: {},
		description: 'Comma-separated list of rate plan IDs, at least one',
		options: [
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['RateplanRate-plans$countGet'], resource: ['rateplan'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { operation: ['RateplanRate-plansByIdHead'], resource: ['rateplan'] } },
		default: '',
		description: 'The ID of the rate plan',
	},
	{
  ...
  "ageCategories": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['RateplanRate-plansByIdDelete'], resource: ['rateplan'] },
		},
		default: '',
		description: 'The ID of the rate plan',
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: false,
				description:
					'Whether if set to true, return only services that can be sold as extras. Otherwise, it returns both, extras, and include-only.',
			},
			{
				displayName: 'pageNumber',
				name: 'pageNumber',
			...
			},
			{
				...
				options: [
					...
					{ name: 'FoodAndBeverages', value: 'FoodAndBeverages' },
					{ name: 'Other', value: 'Other' },
				],
			},
			{
...
`,
	...
	},
	{
		...
		type: 'collection',
		displayOptions: { show: { operation: ['RateplanServices$countGet'], resource: ['service'] } },
		default: {},
		options: [
			{
				displayName: 'channelCodes',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['ReportsReportsOrdered-servicesGet'], resource: ['reports'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['ReportsReportsProperty-performanceGet'], resource: ['reports'] },
		},
		default: '',
		description: 'The ID of the property',
	},
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['ReportsReportsCompany-invoices-vatGet'], resource: ['reports'] },
		},
		default: '',
		description: 'Property ID',
	},
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['SettingsCapture-policiesGet'], resource: ['capturepolicies'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsCapture-policiesByIdGet'], resource: ['capturepolicies'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsCapture-policiesByIdPatch'], resource: ['capturepolicies'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		type: 'string',
		required: true,
		displayOptions: { show: { operation: ['SettingsCity-taxByIdDelete'], resource: ['citytax'] } },
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accountsGet'], resource: ['customsubaccounts'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accountsPost'], resource: ['customsubaccounts'] },
		},
		default: `{
  "propertyId": "MUC",
  "code": "TEA",
  ...
  "type": "FoodAndBeverages"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accounts$countGet'], resource: ['customsubaccounts'] },
		},
		default: '',
		description: 'ID of the property',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accountsByIdGet'], resource: ['customsubaccounts'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accountsByIdPatch'], resource: ['customsubaccounts'] },
		},
		default: '',
		description: 'The ID of the sub-account',
	},
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accountsByIdHead'], resource: ['customsubaccounts'] },
		},
		default: '',
		description: 'The ID of the sub-account',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsSub-accountsByIdDelete'], resource: ['customsubaccounts'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsFeaturesByPropertyIdGet'], resource: ['featuresettings'] },
		},
		default: '',
		description: 'The ID of the property',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsFeaturesByPropertyIdPatch'], resource: ['featuresettings'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['SettingsInvoice-addressGet'], resource: ['invoiceaddress'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsInvoice-addressPut'], resource: ['invoiceaddress'] },
		},
		typeOptions: { multipleValues: true },
		default: {},
		options: [
  ...
  "countryCode": "DE"
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsInvoice-addressPatch'], resource: ['invoiceaddress'] },
		},
		typeOptions: { multipleValues: true },
		default: {},
		options: [
...
`,
  ...
  "languages": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsMarket-segmentsByIdGet'], resource: ['marketsegment'] },
		},
		default: '',
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsMarket-segmentsByIdHead'], resource: ['marketsegment'] },
		},
		default: '',
		description: 'The ID of the market segment',
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsMarket-segmentsByIdPatch'], resource: ['marketsegment'] },
		},
		default: '',
...
`,
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsMarket-segmentsByIdDelete'], resource: ['marketsegment'] },
		},
		default: '',
		description: 'The ID of the market segment',
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['SettingsMarket-segmentsGet'], resource: ['marketsegment'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsMarket-segmentsPost'], resource: ['marketsegment'] },
		},
		default: `{
  "code": "BUSR",
  ...
  "propertyIds": [
	...
	},
	{
		...
		type: 'collection',
		displayOptions: {
			show: { operation: ['SettingsMarket-segments$countGet'], resource: ['marketsegment'] },
		},
		default: {},
		options: [
			{
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SettingsPropertiesByIdGet'], resource: ['propertysettings'] },
		},
		default: '',
		description: 'The ID of the property',
	},
...
`,
	...
	},
	{
		...
		displayOptions: {
			show: {
				operation: ['SettingsPropertiesByPropertyIdTime-slice-definitionsByIdDelete'],
				resource: ['timeslicedefinitions'],
			},
		},
		default: '',
  ...
  "propertyIds": [
	...
	},
	{
		...
		required: true,
		displayOptions: {
			show: { operation: ['SubscriptionsByIdDelete'], resource: ['subscriptions'] },
		},
		default: '',
